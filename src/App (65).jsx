...
const NL = C; // alias usado en componentes del nuevo diseño
...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    const color = navy ? "#0B1430" : "#F2F4F8";
  ...
  return (
    <>
      ...
      {/* Cargando auth — evita pantalla blanca entre splash y respuesta de Firebase */}
      {!splash && !authReady && (
        <div style={{ position:"absolute", inset:0, background:"#060A18", display:"flex", alignItems:"center", justifyContent:"center", zIndex:900 }}>
          <div style={{ width:28, height:28, border:"3px solid rgba(255,255,255,0.12)", borderTopColor:"#2563EB", borderRadius:"50%", animation:"spin .7s linear infinite" }}/>
        </div>
      )}
      ...
      {/* Pantalla principal: solo se muestra cuando hay usuario autenticado */}
      {!splash && authReady && user && <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden" }}>
        ...
        <div style={{
          ...
          background: (tab === "hoy" && !showProfile)
            ? "linear-gradient(180deg, #0B1430 0%, #0E1A3B 100%)"
