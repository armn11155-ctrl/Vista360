...
function HeroCard({ panalesLibres, contratos = [], setTab = () => {} }) {
  ...
  return (
    <div style={{
      ...
      <div aria-hidden style={{ position:"absolute", inset:0, pointerEvents:"none", overflow:"hidden", borderBottomLeftRadius:28, borderBottomRightRadius:28 }}>
        <div style={{ position:"absolute", top:-140, right:-40, width:340, height:340, borderRadius:"50%", background:"radial-gradient(closest-side, rgba(29,107,255,0.38), rgba(29,107,255,0))", filter:"blur(2px)" }}/>
        <div style={{ position:"absolute", top:40, left:-100, width:260, height:260, borderRadius:"50%", background:"radial-gradient(closest-side, rgba(80,140,255,0.20), rgba(0,0,0,0))" }}/>
      </div>
      ...
      <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden" }}>
        ...
        <div style={{
          ...
          background: (tab === "hoy" && !showProfile)
            ? `radial-gradient(ellipse 320px 220px at 100% 120%, rgba(29,107,255,0.32), transparent 65%), radial-gradient(ellipse 280px 200px at 0% 140%, rgba(80,140,255,0.16), transparent 70%), linear-gradient(180deg, #0B1430 0%, #0E1A3B 100%)`
