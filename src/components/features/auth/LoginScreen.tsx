  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (
        ...
        setError("⚙️ API key no válida. Revisa las variables de entorno.");
      else
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (e.code === "auth/popup-closed-by-user")
        ...
        setError("Tu navegador bloqueó la ventana. Permite popups para este sitio.");
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            width: "70%", height: "60%",
            background: "radial-gradient(ellipse, rgba(37,99,235,.28) 0%, transparent 65%)",
            pointerEvents: "none",
          }} />
          <div style={{
          ...
          <div style={{
            ...
            <div style={{ filter: "drop-shadow(0 0 32px rgba(37,99,235,.45))", marginBottom: 36 }}>
              <Logo360 width={200} />
            </div>
          ...
          <div style={{
            ...
            fontSize: 11, color: "rgba(255,255,255,.25)", letterSpacing: .3,
          }}>
            v{APP_VERSION}
          </div>
        </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                opacity: loadingG ? .5 : 1,
                boxShadow: "0 3px 14px rgba(37,99,235,.28)",
                letterSpacing: ".15px",
              }}
            >
              {loading
                ? <>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                      ...
                      style={{ animation: "v360spin .75s linear infinite" }}>
            ...
            >
              {loadingG
                ? <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#6B7280"
                    strokeWidth="2.3" strokeLinecap="round"
                    style={{ animation: "v360spin .75s linear infinite" }}>
                    <path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/>
                  </svg>
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (e.code === "auth/popup-closed-by-user")
        ...
        setError("Tu navegador bloqueó la ventana. Permite popups.");
      else if (e.code === "auth/operation-not-allowed")
        setError("Google Sign-In no habilitado en Firebase Console.");
      else if (e.code?.includes("api-key-not-valid"))
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            letterSpacing: "-0.6px", textShadow: "0 2px 18px rgba(0,0,0,.45)",
          }}>
            Alan Martínez
          </div>
        </div>
