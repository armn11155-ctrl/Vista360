...
vi.mock("../../config/theme", () => ({
  T: { bg:"#fff",card:"#fff",surface:"#f9fafb",border:"#e5e7eb",text:"#111",
       muted:"#6b7280",accent:"#2563eb",red:"#ef4444",green:"#10b981",
       white:"#fff",dark:"#1f2937",yellow:"#f59e0b" },
  tCol: vi.fn(() => "#2563eb"),
}));
vi.mock("../../config/constants", () => ({
  CIUDADES:["Lima"], CAT_GASTOS:["Mantenimiento"], CAT_PROVE:["Elect"],
...
const props = {
  paneles: [], clientes: [], contratos: [], gastos: [],
  setTab: vi.fn(), userName: "Admin",
};
...
describe("ResumenNuevo", () => {
  ...
  it("renderiza con paneles y contratos", () => {
    const p = [{ id:"p1", nombre:"Panel Norte", tipo:"LED", ciudad:"Lima", estado:"Disponible" as const }];
    const c = [{ id:"c1", panel_id:"p1", cliente_id:"cl1", inicio:"2024-01-01", fin:"2024-12-31", monto:1500, pagado:false, pagosMeses:{} }];
