...
describe("PanelCard", () => {
  it("muestra el nombre del panel", () => {
    render(<PanelCard panel={mockPanel} carasOcupadas={{ A: false, B: false }} onEdit={vi.fn()} onDelete={vi.fn()} />);
  ...
  it("muestra 'Ocupado' cuando está ocupado", () => {
    render(<PanelCard panel={mockPanel} carasOcupadas={{ A: true, B: false }} onEdit={vi.fn()} onDelete={vi.fn()} />);
    expect(screen.getByText("Ocupado")).toBeTruthy();
  });

  it("llama a onEdit cuando se hace clic en Editar", () => {
    const onEdit = vi.fn();
    render(<PanelCard panel={mockPanel} carasOcupadas={{ A: false, B: false }} onEdit={onEdit} onDelete={vi.fn()} />);
  ...
  it("llama a onDelete con el id correcto al eliminar", () => {
    ...
    render(<PanelCard panel={mockPanel} carasOcupadas={{ A: false, B: false }} onEdit={vi.fn()} onDelete={onDelete} />);
  ...
  it("no muestra la dirección cuando no está definida", () => {
    ...
    render(
      <PanelCard panel={panelSinDireccion} carasOcupadas={{ A: false, B: false }} onEdit={vi.fn()} onDelete={vi.fn()} />,
    );
