...
vi.mock("../../../config/constants", () => ({
  CIUDADES:["Lima"], CAT_GASTOS:["Mant"], CAT_PROVE:["Electricidad","Telecomunicaciones"],
  SECTORES:["Retail"], ESTADOS_CLI:["Activo"], ESTADOS_PRO:["En contacto","Frío"],
...
describe("Proveedores — con datos", () => {
  const proveedores = [
    { id:"pv1", nombre:"Proveedor Uno", estado:"En contacto" as const, ruc:"20111", sector:"Electricidad" },
    { id:"pv2", nombre:"Proveedor Dos", estado:"Frío" as const, ruc:"20222", sector:"Telecomunicaciones" },
  ];
