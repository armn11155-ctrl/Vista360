...
vi.mock("firebase/auth", () => ({ getAuth:vi.fn(()=>({currentUser:{uid:"u1",email:"a@test.com"}})), signOut:vi.fn() }));
...
vi.mock("../../../config/constants", () => ({
  ...
  EMOJIS:["🖥"], EMISOR:{ruc:"20123456789",nombre:"Test SA",direccion:"Av Test",ubigeo:"150101",ciudad:"Lima"},
