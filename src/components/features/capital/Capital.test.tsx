...
const props = { paneles:[], contratos:[], gastos:[], proveedores:[] };

beforeEach(()=>vi.clearAllMocks());

describe("Capital", () => {
  it("renderiza sin errores", () => {
    expect(() => render(<Capital {...props} />)).not.toThrow();
  });
  it("muestra contenido", () => {
    render(<Capital {...props} />);
...
describe("Capital — interacciones UI básicas", () => {
  it("responde a clicks e inputs sin lanzar error", () => {
    const { container } = render(<Capital {...props} />);
