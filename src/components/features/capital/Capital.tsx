          ...
          {TABS.map(t => (
            <button
              ...
              style={{
                ...
                whiteSpace: "nowrap",
                flexShrink: 0,
                background: section === t.id ? "rgba(16,185,129,0.18)" : "rgba(37,99,235,0.14)",
                border: `1px solid ${section === t.id ? "rgba(16,185,129,0.45)" : "rgba(59,130,246,0.35)"}`,
                color: section === t.id ? "#34D399" : "#60A5FA",
                fontSize: 12,
