// Historico — migrado de App-15.tsx (líneas 6400-6755)
...
// TODO: Pegar aqui el cuerpo del componente desde App-15.tsx líneas 6400-6755
export default function Historico(props: any) {
  return (
    <div style={{ padding: 20 }}>
      <div style={{ fontSize: 20, fontWeight: 800, color: T.text, marginBottom: 12 }}>Historico</div>
      <div style={{ fontSize: 13, color: T.muted, background: "#EFF4FF", padding: 16, borderRadius: 12 }}>
        Copia el código desde App-15.tsx líneas 6400-6755 e insértalo aquí.
