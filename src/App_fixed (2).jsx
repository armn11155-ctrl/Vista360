...
export default function App() {
  ...
  useEffect(() => {
    if (!user) { setLoading(false); return; }  // Sin sesión → no cargar
    setLoading(true);

    // Timeout de seguridad: si Firebase no responde en 15 s
    // (sin red o reglas de seguridad que no rechazan sino que cuelgan)
    // la promesa race lo rechaza y se para el spinner.
