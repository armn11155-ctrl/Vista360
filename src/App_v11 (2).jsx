    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        html{margin:0;padding:0;background:#F2F4F8;width:100%;height:-webkit-fill-available;height:100%;-webkit-text-size-adjust:100%}
        body{margin:0;padding:0;background:#F2F4F8;width:100%;min-height:-webkit-fill-available;min-height:100%;overscroll-behavior:none;-webkit-text-size-adjust:100%;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden" }}>
