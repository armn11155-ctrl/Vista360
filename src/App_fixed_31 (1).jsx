...
function Capital({ paneles, contratos, gastos, proveedores }) {
  ...
  const renderPatrimonio = () => (
    <div>
      {/* Hero patrimonio */}
      <CapCard accent="#3B82F6" style={{padding:"26px 22px 22px",marginBottom:12,background:"linear-gradient(145deg,#0D2B1F,#0A1F18)"}}>
        <div style={{fontSize:10,fontWeight:700,color:"#3B82F6",letterSpacing:2.5,textTransform:"uppercase",marginBottom:8}}>Patrimonio neto total</div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:20}}>
          <span style={{fontSize:12,fontWeight:700,color:patrimonioChange>=0?"#60A5FA":"#F87171",background:patrimonioChange>=0?"rgba(52,211,153,0.15)":"rgba(248,113,113,0.15)",borderRadius:99,padding:"3px 10px"}}>
      ...
      <CapCard style={{padding:"18px 20px",marginBottom:12}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
          {[
            {label:"Ingresos",   value:ingMes,    color:"#3B82F6", bg:"#F0FDF4", icon:"↑"},
            {label:"Gastos",     value:gastosMes, color:"#EF4444", bg:"#FEF2F2", icon:"↓"},
            {label:"Por cobrar", value:porCobrar, color:"#3B82F6", bg:"#F0FDF4", icon:"⏳"},
