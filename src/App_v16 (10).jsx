    ...
    <>
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", overscrollBehavior: "none" }}>
        ...
        {/* ── BOTTOM BACKGROUND FILL ──
             Cubre: safe-area + tab bar height completo
             Esto evita que el contenido oscuro se vea a través
             de las esquinas redondeadas y márgenes del tab bar ── */}
        <div style={{
          position:"fixed", bottom:0, left:0, right:0,
          height:"calc(env(safe-area-inset-bottom, 0px) + 90px)",
          background: NL.bg,
          zIndex:97,
          pointerEvents:"none",
        }}/>
