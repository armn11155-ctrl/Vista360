...
function Contratos({contratos,setContratos,paneles,clientes,loading,setTab,onModalChange}){
  ...
  const onFieldFocus=()=>{ if(blurTimer.current)clearTimeout(blurTimer.current); selectingRef.current=true; };
  const onFieldBlur=()=>{ blurTimer.current=setTimeout(()=>{ selectingRef.current=false; },800); };
  const markSelecting=()=>{ onFieldFocus(); };
  ...
  return(<div>
    {modal&&(
      <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:400,display:"flex",alignItems:"flex-end",justifyContent:"center",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)"}}
        onClick={e=>{if(!selectingRef.current&&e.target===e.currentTarget){setModal(null);onModalChange?.(false);}}}
      >
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:"22px 22px 0 0",padding:"10px 20px 24px",width:"100%",maxHeight:"92vh",overflowY:"auto",WebkitOverflowScrolling:"touch",paddingBottom:"calc(24px + env(safe-area-inset-bottom))",boxShadow:"0 -10px 40px rgba(0,0,0,0.45)"}}
        ...
        >
          ...
          <F label="Panel *">
            <select value={form.panel_id}
              onChange={e=>{markSelecting();setForm(f=>({...f,panel_id:e.target.value}))}}
              onFocus={onFieldFocus}
              onBlur={onFieldBlur}
              onMouseDown={e=>e.stopPropagation()}
              onTouchStart={e=>{markSelecting();e.stopPropagation();}}
          ...
          <F label="Cliente *">
            <select value={form.cliente_id}
              onChange={e=>{markSelecting();setForm(f=>({...f,cliente_id:e.target.value}))}}
              onFocus={onFieldFocus}
              onBlur={onFieldBlur}
              onMouseDown={e=>e.stopPropagation()}
              onTouchStart={e=>{markSelecting();e.stopPropagation();}}
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            <F label="Fecha inicio *">
              <input type="date" value={form.inicio}
                onChange={e=>{markSelecting();setForm(f=>({...f,inicio:e.target.value,pagosMeses:{}}));}}
                onFocus={onFieldFocus}
                onBlur={onFieldBlur}
                onMouseDown={e=>e.stopPropagation()}
                onTouchStart={e=>{markSelecting();e.stopPropagation();}}
            ...
            <F label="Fecha fin *">
              <input type="date" value={form.fin}
                onChange={e=>{markSelecting();setForm(f=>({...f,fin:e.target.value,pagosMeses:{}}));}}
                onFocus={onFieldFocus}
                onBlur={onFieldBlur}
                onMouseDown={e=>e.stopPropagation()}
                onTouchStart={e=>{markSelecting();e.stopPropagation();}}
...
function Historico({contratos,setContratos,paneles,clientes,onModalChange}){
  ...
  return(<div>
    ...
    {modal&&(
      <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:400,display:"flex",alignItems:"flex-end",justifyContent:"center",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)"}}
        onClick={e=>{if(!selectingRef.current&&e.target===e.currentTarget) closeModal();}}>
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:"22px 22px 0 0",padding:"10px 20px 24px",width:"100%",maxHeight:"92vh",overflowY:"auto",WebkitOverflowScrolling:"touch",paddingBottom:"calc(24px + env(safe-area-inset-bottom))",boxShadow:"0 -10px 40px rgba(0,0,0,0.45)"}}
          onMouseDown={e=>e.stopPropagation()}
          ...
          <F label="Panel *">
            <select value={form.panel_id} onChange={e=>{markSelecting();setForm(f=>({...f,panel_id:e.target.value}));}}
              onFocus={onFieldFocus} onBlur={onFieldBlur}
              onMouseDown={e=>e.stopPropagation()} onTouchStart={e=>{markSelecting();e.stopPropagation();}} onTouchEnd={e=>e.stopPropagation()} onPointerDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
              style={selStyle}>
              <option value="">— Selecciona un panel —</option>
              {paneles.map(p=><option key={p.id} value={p.id}>{p.foto} {p.nombre} · {p.ciudad} · {p.estado}</option>)}
            </select>
          ...
          <F label="Cliente *">
            <select value={form.cliente_id} onChange={e=>{markSelecting();setForm(f=>({...f,cliente_id:e.target.value}));}}
              onFocus={onFieldFocus} onBlur={onFieldBlur}
              onMouseDown={e=>e.stopPropagation()} onTouchStart={e=>{markSelecting();e.stopPropagation();}} onTouchEnd={e=>e.stopPropagation()} onPointerDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
              style={selStyle}>
              <option value="">— Selecciona un cliente —</option>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            <F label="Fecha inicio *">
              <input type="date" value={form.inicio} onChange={e=>{markSelecting();setForm(f=>({...f,inicio:e.target.value,pagosMeses:{}}));}}
                onFocus={onFieldFocus} onBlur={onFieldBlur}
                onMouseDown={e=>e.stopPropagation()} onTouchStart={e=>{markSelecting();e.stopPropagation();}} onTouchEnd={e=>e.stopPropagation()} onPointerDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
                style={{...inpStyle,colorScheme:"light",cursor:"pointer",fontSize:16}}/>
            </F>
            <F label="Fecha fin *">
              <input type="date" value={form.fin} onChange={e=>{markSelecting();setForm(f=>({...f,fin:e.target.value,pagosMeses:{}}));}}
                onFocus={onFieldFocus} onBlur={onFieldBlur}
                onMouseDown={e=>e.stopPropagation()} onTouchStart={e=>{markSelecting();e.stopPropagation();}} onTouchEnd={e=>e.stopPropagation()} onPointerDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
                style={{...inpStyle,colorScheme:"light",cursor:"pointer",fontSize:16}}/>
            </F>
          ...
          <F label="Monto mensual (S/) *">
            <input type="text" inputMode="decimal" value={form.monto}
              ...
              onMouseDown={e=>e.stopPropagation()} onFocus={onFieldFocus} onBlur={onFieldBlur} onTouchStart={e=>{markSelecting();e.stopPropagation();}} onTouchEnd={e=>e.stopPropagation()} onPointerDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
