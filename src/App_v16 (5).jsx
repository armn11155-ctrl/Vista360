...
export default function App() {
  ...
  useEffect(() => {
    // Solo overflow+overscroll via CSS es suficiente para prevenir el bounce en iOS moderno
    // position:fixed en body ROMPE las coordenadas táctiles de iOS — NO usarlo
    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        ...
        /* ── TOQUE INMEDIATO EN TODOS LOS ELEMENTOS ──
           touch-action:manipulation elimina el delay de 300ms en iOS Safari
           El scroll container sobrescribe esto con pan-y via inline style */
        *{touch-action:manipulation}

        /* ── LAYOUT BASE ── */
        :root{--app-h:100dvh}
        html,body{margin:0;padding:0;width:100%;height:100%;overflow:hidden;overscroll-behavior:none;background:#0A0F1E;-webkit-text-size-adjust:100%}
        ...
        /* ── #root: SÍ usa position:fixed — es el contenedor de la app ── */
        #root{position:fixed;top:0;left:0;right:0;bottom:0;overflow:hidden;background:#0A0F1E}
        ...
        /* ── INPUTS ── */
        input,select,textarea{-webkit-appearance:none;appearance:none;font-size:16px!important;scroll-margin-bottom:180px}
