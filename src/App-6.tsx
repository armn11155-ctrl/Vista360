...
const PgTit  = ({ icon, title, sub, dark }: PgTitProps) => (
  <div style={{ marginBottom: 22, padding: "16px 16px 0" }}>
    <div style={{ fontSize: 22, fontWeight: 800, color: dark ? "#fff" : T.text, letterSpacing: "-0.5px" }}>
      {icon} {title}
    </div>
    {sub && <div style={{ fontSize: 13, color: dark ? "rgba(255,255,255,0.5)" : T.muted, marginTop: 3 }}>{sub}</div>}
  </div>
);
const Spinner = () => (
  ...
  return(<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:18,flexWrap:"wrap",gap:10}}>
      ...
      <button onClick={openNew} style={{
        ...
        background:T.accent,border:"none",borderRadius:14,padding:"12px 18px",
  ...
  return (
    <div style={{ paddingBottom: 32 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}>
        <div style={{ width: 60, height: 60, borderRadius: 14, background: T.white, border: "1px solid #E5E7EB", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, boxShadow: "0 2px 10px rgba(15,23,41,0.04)" }}>
          <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
            <rect x="5" y="3" width="14" height="18" rx="1.5" fill={T.white} stroke="#0F1729" strokeWidth="1.4"/>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 26, fontWeight: 900, color: T.text, letterSpacing: "-0.7px", lineHeight: 1.1, marginBottom: 4 }}>Facturación</div>
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
                        <div>
                          ...
                          <div style={{fontSize:13.5,fontWeight:900,color:T.green,fontFamily:"monospace",marginTop:2,fontVariantNumeric:"tabular-nums"}}>{fmt(m.ingPagado)}</div>
                        </div>
                        <div>
                          <div style={{fontSize:9,fontWeight:700,color:"#5B7FCC",letterSpacing:0.8}}>GASTOS</div>
                          <div style={{fontSize:13.5,fontWeight:900,color:T.red,fontFamily:"monospace",marginTop:2,fontVariantNumeric:"tabular-nums"}}>{fmt(m.gastosMes)}</div>
                        </div>
                        <div>
                          <div style={{fontSize:9,fontWeight:700,color:"#5B7FCC",letterSpacing:0.8}}>UTILIDAD</div>
                          <div style={{fontSize:13.5,fontWeight:900,color:m.utilidad>=0?T.green:T.red,fontFamily:"monospace",marginTop:2,fontVariantNumeric:"tabular-nums"}}>{fmt(m.utilidad)}</div>
                        </div>
                      </div>
