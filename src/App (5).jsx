...
export default function App() {
  ...
  return (
    <>
      ...
      <div style={{ width: "100%", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", position: "fixed", top: 0, left: 0, right: 0, bottom: "-env(safe-area-inset-bottom)", height: "calc(100% + env(safe-area-inset-bottom))" }}>
