...
;(function(){
  try {
    ...
    var c  = 'width=device-width,initial-scale=1,maximum-scale=1,viewport-fit=cover,user-scalable=no';
...
const DRAWER_LOGO_B64 = "data:image/png;base64,";
  ...
  return(<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:22}}>
      ...
      <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
        ...
        }} style={{background:"linear-gradient(135deg,#2B4EE6 0%,#4F7AFF 100%)",border:"none",borderRadius:50,padding:"10px 18px",color:"#FFFFFF",fontWeight:700,fontSize:13,cursor:"pointer",display:"flex",alignItems:"center",gap:6,boxShadow:"0 4px 18px rgba(79,122,255,0.38), inset 0 1px 0 rgba(255,255,255,0.18)",transition:"all 0.18s",letterSpacing:"0.01em",minHeight:44}}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>
          Exportar PDF
        </button>
                  ...
                  <div key={m.key}
                    ...
                    <div style={{display:"flex",gap:8}}>
                      <button onClick={()=>exportarPDF(m.key,m.label,fmt(m.ing),fmt(m.gas),fmt(m.util),mg,gastosDelMes)}
                        style={{flex:1,background:"linear-gradient(135deg,#2B4EE6 0%,#4F7AFF 100%)",border:"none",borderRadius:50,padding:"11px 18px",color:"#FFFFFF",fontWeight:700,fontSize:13,cursor:"pointer",minHeight:44,display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:"0 4px 18px rgba(79,122,255,0.38), inset 0 1px 0 rgba(255,255,255,0.18)",transition:"all 0.18s",letterSpacing:"0.01em",fontFamily:"inherit"}}>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>
                        Exportar PDF
                      </button>
      ...
      :<div style={{display:"flex",flexDirection:"column",gap:10}}>
        {delMes.map(g=>{
          ...
          <div key={g.id}
            ...
            style={{position:"relative",overflow:"hidden",background:"linear-gradient(145deg,#0E1835 0%,#0A1228 100%)",border:"1px solid rgba(79,124,255,0.14)",borderRadius:18,padding:"14px 16px",boxShadow:"0 6px 20px rgba(8,12,28,0.4), inset 0 1px 0 rgba(255,255,255,0.04)",cursor:"pointer",transition:"border-color .2s"}}>
            <svg viewBox="0 0 400 120" preserveAspectRatio="none"
              style={{position:"absolute",left:0,right:0,bottom:0,width:"100%",height:80,pointerEvents:"none",opacity:0.35}}>
              <defs>
                <linearGradient id={wid} x1="0" y1="0" x2="1" y2="0">
            ...
            <div style={{position:"relative",zIndex:2}}>
              ...
              <div style={{display:"flex",gap:8,justifyContent:"flex-end",flexWrap:"wrap"}} onClick={e=>e.stopPropagation()}>
                <button onClick={()=>abrirEditar(g)} style={{background:"rgba(37,99,235,0.12)",border:"1px solid rgba(37,99,235,0.45)",borderRadius:10,padding:"7px 14px",color:"#5A9BFF",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6,fontFamily:"inherit"}}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg>
                  Editar
                </button>
                <button onClick={()=>setVistaDetalle(g)} style={{background:"rgba(16,185,129,0.12)",border:"1px solid rgba(16,185,129,0.45)",borderRadius:10,padding:"7px 14px",color:"#10B981",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6,fontFamily:"inherit"}}>
                ...
                <button onClick={()=>eliminar(g.id)} style={{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.45)",borderRadius:10,padding:"7px 14px",color:"#EF4444",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6,fontFamily:"inherit"}}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                  Eliminar
                </button>
              </div>
        ...
        <div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18,flexWrap:"wrap",gap:10}}>
            ...
            <button onClick={exportResumenPDF} style={{
              ...
              background:"linear-gradient(135deg,#2B4EE6 0%,#4F7AFF 100%)",
              color:"#FFFFFF",fontWeight:700,fontSize:13,cursor:"pointer",fontFamily:"inherit",
              boxShadow:"0 4px 18px rgba(79,122,255,0.38), inset 0 1px 0 rgba(255,255,255,0.18)",
              transition:"all 0.18s",letterSpacing:"0.01em",minHeight:44,
            }}>
      ...
      {seccion==="mensual" && (
        <div>
          ...
          <button onClick={exportAnualMensualPDF} style={{
            ...
            padding:"13px 20px",borderRadius:50,marginBottom:14,cursor:"pointer",
            background:"linear-gradient(135deg,#2B4EE6 0%,#4F7AFF 100%)",
            border:"none",
            color:"#FFFFFF",fontWeight:800,fontSize:13.5,fontFamily:"inherit",
            boxShadow:"0 4px 22px rgba(79,122,255,0.40), inset 0 1px 0 rgba(255,255,255,0.18)",
            transition:"all 0.18s",letterSpacing:"0.01em",minHeight:48,
          }}>
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10,flexWrap:"wrap"}}>
                        ...
                        <button onClick={()=>exportMesPDF(m)} style={{
                          ...
                          border:"none",
                          background:"linear-gradient(135deg,#2B4EE6 0%,#4F7AFF 100%)",
                          color:"#FFFFFF",fontWeight:700,fontSize:11.5,cursor:"pointer",fontFamily:"inherit",
                          boxShadow:"0 3px 12px rgba(79,122,255,0.38), inset 0 1px 0 rgba(255,255,255,0.15)",
                          transition:"all 0.18s",letterSpacing:"0.01em",minHeight:30,
...
export default function App() {
  ...
  // ── ANTI-BOUNCE iOS: solución completa ──
  useEffect(() => {
    // 1. Fijar html/body — sin espacio para rebotar
    const htmlStyle = "position:fixed;width:100%;height:100%;overflow:hidden;overscroll-behavior:none;";
    const bodyStyle = "position:fixed;width:100%;height:100%;overflow:hidden;overscroll-behavior:none;top:0;left:0;right:0;bottom:0;";
    document.documentElement.style.cssText += htmlStyle;
    document.body.style.cssText += bodyStyle;

    // 2. Bloquear touchmove en el documento EXCEPTO dentro del contenedor scrollable.
    // IMPORTANTE: solo bloquear si el dedo se movió > 6px, para no cancelar taps/clicks en botones.
    ...
    const blockDocumentScroll = (e) => {
      const movedY = Math.abs(e.touches[0].clientY - docTouchStartY);
      const movedX = Math.abs(e.touches[0].clientX - docTouchStartX);
      // Si el movimiento es menor a 6px en cualquier dirección, es un tap → NO bloquear
      if (movedY < 6 && movedX < 6) return;
      let el = e.target;
      while (el && el !== document.body) {
        if (el.dataset && el.dataset.scroll !== undefined) return;
        el = el.parentElement;
      }
      e.preventDefault();
    };
    ...
    // 3. Interceptar touchmove en el scroll container para bloquear bounce en los límites
    ...
    if (container) {
      ...
      const onTouchMove = (e) => {
        ...
        // Si intenta rebotar arriba o abajo → bloquear
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        html{margin:0;padding:0;background:#0E1A3B;width:100%;height:100%;height:100vh;height:100dvh;overflow:hidden;-webkit-text-size-adjust:100%;overscroll-behavior:none}
        body{margin:0;padding:0;background:#0E1A3B;width:100%;height:100%;height:100vh;height:100dvh;overflow:hidden;overscroll-behavior:none;position:fixed;top:0;left:0;right:0;bottom:0;-webkit-text-size-adjust:100%;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
        #root{width:100%;height:100%;overflow:hidden;position:fixed;top:0;left:0;right:0;bottom:0;background:#F2F4F8}
        ::-webkit-scrollbar{display:none}
        /* Anti-bounce: todos los scrollables internos */
        [data-scroll]{overscroll-behavior:none!important;overscroll-behavior-y:none!important;-webkit-overflow-scrolling:auto!important;scroll-snap-type:none}
        /* Scroll premium: momentum suave sin bounce */
        [data-scroll-momentum]{overscroll-behavior:contain;scroll-behavior:smooth}
        /* Nukear overscroll en CUALQUIER elemento con overflow scroll/auto */
        *{overscroll-behavior:none!important}
        /* Forzar que el fondo no sea visible al hacer pull */
        html,body,#root{background:#0E1A3B!important}
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", overscrollBehavior: "none" }}>
        ...
        <div
          ref={scrollRef}
          data-scroll
          style={{ flex: 1, minHeight: 0, overflowY: "scroll", overflowX: "hidden", overscrollBehavior: "none", overscrollBehaviorY: "none", scrollBehavior: "smooth", WebkitOverflowScrolling: "auto", touchAction: "pan-y" }}
        >
