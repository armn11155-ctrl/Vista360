...
// ── TabSuspense: fallback mientras carga el chunk lazy ────────────
...
// ── FirebaseStatus (pantalla de perfil) ───────────────────────────
...
function getHeaderColor(pathname: string, isProfile: boolean): string {
  ...
  return HEADER_COLORS[pathname] ?? T.bg;
}

// ══════════════════════════════════════════════════════════════════
// APP SHELL — envuelve las rutas y provee el estado global
// ══════════════════════════════════════════════════════════════════
function AppShell() {
  useViewportSetup();
...
// ── ProfileView — extraído de App para mantener AppShell limpio ───
...
// ── Root export — envuelve todo en HashRouter ─────────────────────
// HashRouter no requiere configuración en el servidor (funciona en Cloudflare Pages,
// GitHub Pages, cualquier hosting estático). Las URLs quedan como /#/paneles.
