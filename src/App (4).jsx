    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
        html,body{margin:0;padding:0;background:#0A0F1E;height:100%;overscroll-behavior-y:none;-webkit-text-size-adjust:100%}
      ...
      <div style={{ width: "100%", minHeight: "100dvh", height: "100%", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", position: "fixed", inset: 0 }}>
