  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "26px 24px 28px", display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 270 }}>
        ...
        {/* Bloque superior: etiqueta + título */}
        <div>
          <div style={{ fontSize: 10, fontWeight: 700, color: "#5B9BFF", letterSpacing: 2.5, textTransform: "uppercase", marginBottom: 12, opacity: 0.85 }}>
            Resumen de hoy
          </div>
          <div style={{ fontSize: 36, fontWeight: 800, color: "#FFFFFF", lineHeight: 1.05, letterSpacing: "-0.04em" }}>
            Todo bajo<br/>control.
          </div>
        </div>

        {/* Bloque inferior: nombre + fecha */}
        <div style={{ marginTop: 32 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 8 }}>
            <span style={{ fontSize: 12.5, color: "rgba(255,255,255,0.5)", fontWeight: 400 }}>{saludo},</span>
            <span style={{ fontSize: 12.5, color: "#5B9BFF", fontWeight: 700 }}>Alan Martínez</span>
          </div>
          <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 30, padding: "4px 12px" }}>
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.65)", fontWeight: 500, letterSpacing: 0.2 }}>{fechaCap}</span>
          </div>
        </div>
