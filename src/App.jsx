...
const ContratosInp={width:"100%",background:"#111929",border:"1px solid #18253D",borderRadius:10,padding:"10px 13px",color:"#E2E8F0",fontSize:16,outline:"none",fontFamily:"inherit",boxSizing:"border-box",minHeight:44,WebkitAppearance:"none",appearance:"none",MozAppearance:"none"};
...
export default function App(){
  ...
  return(<>
    ...
    <style>{`*{box-sizing:border-box}html,body{margin:0;padding:0;background:#070C18;-webkit-text-size-adjust:100%;overscroll-behavior:none;}body{padding-top:env(safe-area-inset-top);padding-left:env(safe-area-inset-left);padding-right:env(safe-area-inset-right);}::-webkit-scrollbar{width:5px;height:5px}::-webkit-scrollbar-track{background:#070C18}::-webkit-scrollbar-thumb{background:#18253D;border-radius:3px}@keyframes spin{to{transform:rotate(360deg)}}@keyframes pulse{from{opacity:.2}to{opacity:.6}}`}</style>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,minHeight:"100vh",color:C.text,display:"flex",flexDirection:"column"}}>
      ...
      <div style={{paddingTop:"calc(env(safe-area-inset-top) + 68px)",paddingLeft:16,paddingRight:16,paddingBottom:24,maxWidth:1240,width:"100%",margin:"0 auto",boxSizing:"border-box",flex:1}}>
        {error&&(
