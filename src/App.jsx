...
function Gastos({gastos,setGastos}){
  ...
  const escanear=async(file)=>{
    ...
    try{
      ...
      setOcr(o=>({...o,progress:12,fase:"Pre-procesando imagen (escala de grises + contraste)..."}));
      let previewUrl=imgUrl;
      try{
        const resultado=await preprocesarImagen(file);
        previewUrl=resultado.previewUrl;
        setOcr(o=>({...o,previewUrl,progress:28,fase:"Imagen procesada ✓ — Enviando a Google Vision..."}));
      }catch(_){
        setOcr(o=>({...o,progress:28,fase:"Enviando a Google Vision..."}));
      }
