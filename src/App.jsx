  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "22px 22px 22px", maxWidth: "78%" }}>
        {/* Saludo */}
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
          <span style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", fontWeight: 400 }}>{saludo},</span>
          <span style={{ fontSize: 13, color: "#C4B5FD", fontWeight: 700 }}>Alan Martínez</span>
        </div>
        {/* Fecha */}
        <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 30, padding: "4px 11px", marginBottom: 14 }}>
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>{fechaCap}</span>
        </div>
        <div style={{
