  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100dvh",color:C.text,display:"flex",overflow:"hidden"}}>
      ...
      <aside style={{
        ...
        {/* Logo */}
        <div style={{padding:"14px 0 10px",width:"100%",display:"flex",justifyContent:"center",borderBottom:"1px solid rgba(255,255,255,0.06)",marginBottom:6}}>
          <Logo360 width={40}/>
        </div>
        ...
        <div style={{width:"100%",borderTop:"1px solid rgba(255,255,255,0.06)",paddingBottom:"env(safe-area-inset-bottom)"}}>
          <SideIcon id="perfil" label="Ruben"
            active={showProfile}
          ...
          {showProfile&&(
            <div>
              ...
              <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:24,padding:"20px",background:"linear-gradient(135deg,#1E293B,#0F172A)",borderRadius:16,border:"1px solid rgba(255,255,255,0.08)"}}>
                <img src="https://ui-avatars.com/api/?name=Ruben&background=3B82F6&color=fff&size=64&bold=true" style={{width:64,height:64,borderRadius:"50%",border:"3px solid #3B82F6"}} alt="perfil"/>
                <div>
                  <div style={{fontSize:22,fontWeight:800,color:"#fff"}}>Ruben</div>
