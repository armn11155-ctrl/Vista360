  ...
  return(<div>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:12}}>
      {fil.map(c=>{
        ...
        const statusColor=c.d<=0?C.muted:c.d<=15?C.red:c.d<=60?C.amber:C.green;
        const statusLabel=c.d<=0?`Venció hace ${Math.abs(c.d)}d`:c.d<=15?`Vence en ${c.d}d ⚠️`:c.d<=60?`Vence en ${c.d}d`:c.d<=180?`Vence en ${c.d}d`:`Activo`;
        ...
        return(
          <div key={c.id} style={{
            ...
            <div style={{height:5,background:`linear-gradient(90deg,${statusColor},${statusColor}88)`}}/>
              ...
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
                <div style={{display:"flex",alignItems:"center",gap:12}}>
                  ...
                  <div>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:6}}>
                      <span style={{fontSize:11,background:statusColor+"22",color:statusColor,borderRadius:6,padding:"2px 8px",fontWeight:700}}>{statusLabel}</span>
