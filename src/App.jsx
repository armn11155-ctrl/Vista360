...
function CRM({clientes,setClientes,contratos,loading,onModalChange}){
  ...
  return (
    <div style={{ background: "#F2F4F8", margin: "-20px -16px", minHeight: "100%", paddingBottom: "calc(120px + env(safe-area-inset-bottom))" }}>
      ...
      {/* ── SEARCH ── */}
      <div style={{ padding: "14px 16px", background: "#EFF4FF", borderBottom: "1px solid #BFDBFE" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, background: "#fff", border: "1px solid #BFDBFE", borderRadius: 14, padding: "11px 14px" }}>
      ...
      {/* ── FILTROS ── */}
      <div style={{ display: "flex", gap: 7, padding: "10px 16px 10px", background: "#EFF4FF", borderBottom: "1px solid #BFDBFE", overflowX: "auto" }}>
        {filters.map(f => {
