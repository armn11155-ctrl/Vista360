  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "18px 20px 18px", display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 180 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", fontWeight: 400 }}>{saludo},</span>
          <span style={{ fontSize: 12, color: "#5B9BFF", fontWeight: 700 }}>Alan Martínez</span>
        </div>
        ...
        <div>
          <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 30, padding: "3px 10px" }}>
            <span style={{ fontSize: 10, color: "rgba(255,255,255,0.55)", fontWeight: 500, letterSpacing: 0.2 }}>{fechaCap}</span>
          </div>
        </div>
