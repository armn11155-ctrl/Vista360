  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <div class="totales">
        ...
        ${exonerado ? `<div class="tot-row" style="font-size:10px;color:#059669;margin-top:2px"><span class="lbl" style="color:#059669">Base legal</span><span style="font-size:10px;color:#059669;min-width:220px;text-align:right">Art. 13° Ley N° 27037 — Zona Amazónica Huánuco</span></div>` : ""}
