...
function HeroCard({ panalesLibres }) {
  ...
  return (
    <div style={{
      ...
      <HeroWaveArt/>
      <div style={{ position: "relative", zIndex: 2, padding: "22px 22px 22px", maxWidth: "78%" }}>
        <div style={{
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        ...
        body{margin:0;padding:0;background:#F2F4F8;height:100%;min-height:100vh;min-height:-webkit-fill-available;width:100%;position:fixed;top:0;left:0;overscroll-behavior-y:none;-webkit-text-size-adjust:100%;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
