  ...
  return(<>
    ...
    <div style={{width:"100%",height:"100dvh",backgroundColor:C.bg,display:"flex",flexDirection:"column",margin:0,padding:0,fontFamily:"'DM Sans',sans-serif",color:C.text,overflow:"hidden",position:"relative"}}>
      ...
      <div style={{
        ...
        <main style={{minHeight:"100%",overflowY:"auto",overflowX:"hidden",padding:"20px",paddingBottom:"calc(env(safe-area-inset-bottom) + 32px)",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth",backgroundColor:C.bg}}>
