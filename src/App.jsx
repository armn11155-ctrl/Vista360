...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",minHeight:"100vh",width:"100%",color:C.text,position:"relative"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",minHeight:"100vh",paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:"max(6px, env(safe-area-inset-bottom))",paddingLeft:"10px",paddingRight:"10px",gap:"10px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
