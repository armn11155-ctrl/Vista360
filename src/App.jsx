                    ...
                    return(
                      <button key={m.key} onClick={()=>toggleMesPago(m.key)}
                        style={{
                          ...
                          cursor:"pointer",transition:"background .08s",textAlign:"center"
                        }}>
  ...
  return(<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:22}}>
      ...
      <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
        ...
        }} style={{background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",border:"none",borderRadius:50,padding:"12px 22px",color:"#FFFFFF",fontWeight:700,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:8,boxShadow:"0 4px 22px rgba(30,53,200,0.45), inset 0 1px 0 rgba(255,255,255,0.22)",letterSpacing:"0.01em",minHeight:46,fontFamily:"inherit"}}>
                  ...
                  <div key={m.key}
                    ...
                    <div style={{display:"flex",gap:8}}>
                      <button onClick={()=>exportarPDF(m.key,m.label,fmt(m.ing),fmt(m.gas),fmt(m.util),mg,gastosDelMes)}
                        style={{flex:1,background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",border:"none",borderRadius:50,padding:"12px 22px",color:"#FFFFFF",fontWeight:700,fontSize:14,cursor:"pointer",minHeight:46,display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:"0 4px 22px rgba(30,53,200,0.45), inset 0 1px 0 rgba(255,255,255,0.22)",letterSpacing:"0.01em",fontFamily:"inherit"}}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>
                        Exportar PDF
                      </button>
            ...
            <div style={{flex:1,padding:"20px 24px",overflowY:"auto"}}>
              ...
              <div style={{display:"flex",gap:10,paddingTop:8,flexDirection:"column"}}>
                <button onClick={async()=>{
                  ...
                  if(w){w.document.write(html);w.document.close();}
                }} style={{width:"100%",padding:"12px 22px",background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",border:"none",borderRadius:50,color:"#FFFFFF",fontWeight:700,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:"0 4px 22px rgba(30,53,200,0.45), inset 0 1px 0 rgba(255,255,255,0.22)",letterSpacing:"0.01em",minHeight:46,fontFamily:"inherit"}}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>
              ...
              <div style={{background:C.bg,borderRadius:12,padding:14,border:`1px solid ${C.border}`}}>
                <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>
                  {mesesForm.map((m,i)=>{
                    ...
                    return(
                      <button key={m.key} onClick={()=>toggleMesPago(m.key)}
                        style={{padding:"10px 6px",borderRadius:10,border:`2px solid ${pagado?C.green:C.border}`,background:pagado?C.green+"22":C.surface,cursor:"pointer",transition:"background .08s",textAlign:"center"}}>
                        <div style={{fontSize:10,color:C.muted,marginBottom:3,fontWeight:600}}>Mes {i+1}</div>
                        <div style={{fontSize:12,fontWeight:700,color:pagado?C.green:C.muted,marginBottom:4}}>{m.label}</div>
      ...
      {[
        ...
        <button key={f.id} onClick={()=>setFiltro(f.id)}
          style={{padding:"8px 14px",borderRadius:9,border:"none",
            ...
            fontWeight:700,fontSize:12,cursor:"pointer",transition:"background .08s",
          }}>
          {f.label}
        </button>
      ))}
          ...
          {acciones.slice(0,4).map((a,i)=>{
            ...
            return(
              <div key={i} style={{
                ...
                borderRadius:14,cursor:"pointer",transition:"background .08s",
              }}
        ...
        <div style={{padding:"0 22px",display:"flex",flexDirection:"column",gap:16}}>
          ...
          <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
            ...
            <button onClick={descargar} style={{flex:1,padding:"13px 22px",
              ...
              borderRadius:50,color:"#FFFFFF",fontWeight:700,fontSize:14,cursor:"pointer",
              boxShadow:"0 4px 22px rgba(30,53,200,0.45), inset 0 1px 0 rgba(255,255,255,0.22)",
              display:"flex",alignItems:"center",justifyContent:"center",gap:8,
              minHeight:46,fontFamily:"inherit",letterSpacing:"0.01em"}}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>
        ...
        <div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18,flexWrap:"wrap",gap:10}}>
            ...
            <button onClick={exportResumenPDF} style={{
              ...
              background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",
              color:"#FFFFFF",fontWeight:700,fontSize:14,cursor:"pointer",fontFamily:"inherit",
              boxShadow:"0 4px 22px rgba(30,53,200,0.45), inset 0 1px 0 rgba(255,255,255,0.22)",
      ...
      {seccion==="mensual" && (
        <div>
          ...
          <button onClick={exportAnualMensualPDF} style={{
            ...
            padding:"13px 24px",borderRadius:50,marginBottom:14,cursor:"pointer",
            background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",
            border:"none",
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10,flexWrap:"wrap"}}>
                        ...
                        <button onClick={()=>exportMesPDF(m)} style={{
                          ...
                          border:"none",
                          background:"linear-gradient(135deg,#1E35C8 0%,#3854EE 100%)",
                          color:"#FFFFFF",fontWeight:700,fontSize:12,cursor:"pointer",fontFamily:"inherit",
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Solo cambiar el fondo cuando hay usuario — LoginScreen maneja el suyo via position:fixed
  ...
  // ── VISUAL VIEWPORT + ANTI-BOUNCE iOS ──────────────────────────
  useEffect(() => {
    // 1. Fijar html/body
    ...
    // 2. Visual Viewport API: actualiza --app-h cuando Safari muestra/oculta su barra
    // Esto es la solución real al problema de la barra de iOS Safari
    const updateVH = () => {
    ...
    // El bounce de iOS lo previene solo el CSS:
    // body { position:fixed; overflow:hidden } + overscroll-behavior:none
    // NO se necesita preventDefault() en JS — eso mata la detección de gestos
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        :root{--vh:100dvh;--app-h:100dvh}
        html{margin:0;padding:0;background:#0A0F1E;width:100%;height:100%;height:100vh;height:100dvh;height:-webkit-fill-available;overflow:hidden;-webkit-text-size-adjust:100%;overscroll-behavior:none}
        body{margin:0;padding:0;background:#0A0F1E;width:100%;height:100%;height:100vh;height:100dvh;height:-webkit-fill-available;overflow:hidden;overscroll-behavior:none;position:fixed;top:0;left:0;right:0;bottom:0;-webkit-text-size-adjust:100%;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
        #root{width:100%;height:var(--app-h,100dvh);overflow:hidden;position:fixed;top:0;left:0;right:0;background:#0A0F1E}
        ::-webkit-scrollbar{display:none}
        /* Anti-bounce: todos los scrollables internos */
        [data-scroll]{overscroll-behavior:none;scroll-snap-type:none}
        ...
        button,a,[role='button']{font-family:inherit;touch-action:manipulation;-webkit-tap-highlight-color:transparent;cursor:pointer;user-select:none;-webkit-user-select:none}
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, left: 0, right: 0, height: "var(--app-h, 100dvh)", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", overscrollBehavior: "none" }}>
        ...
        <div
          ref={scrollRef}
          data-scroll
          style={{ flex: 1, minHeight: 0, overflowY: "scroll", overflowX: "hidden", overscrollBehavior: "none", WebkitOverflowScrolling: "touch", touchAction: "pan-y", willChange: "scroll-position" }}
        >
