...
export default function App(){
  ...
  return(<>
    ...
    <div style={{width:"100%",minHeight:"100dvh",backgroundColor:C.bg,display:"flex",flexDirection:"row",margin:0,padding:0,fontFamily:"'DM Sans',sans-serif",color:C.text}}>
      ...
      <div style={{display:"flex",flexDirection:"column",minHeight:"100dvh",paddingTop:"max(44px, calc(env(safe-area-inset-top) + 10px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"8px",position:"relative",zIndex:1,boxSizing:"border-box"}}>

      {/* ══ TOP NAV — dos capas ══ */}
      <div style={{flexShrink:0,display:"flex",flexDirection:"column",gap:6}}>

        {/* ── Capa 1: Header — Logo · Título sección · Avatar ── */}
        <div style={{
          ...
          boxShadow:"0 2px 16px rgba(0,0,0,0.55),inset 0 1px 0 rgba(255,255,255,0.05)",
          position:"relative",overflow:"hidden",
        }}>
          <div style={{position:"absolute",top:0,left:0,right:0,height:1,background:"linear-gradient(90deg,transparent 0%,rgba(79,124,255,0.4) 40%,rgba(155,111,255,0.25) 65%,transparent 100%)",pointerEvents:"none"}}/>

          {/* Logo */}
          <Logo360 width={68}/>

          {/* Título sección activa centrado */}
          <div style={{
            position:"absolute",left:"50%",transform:"translateX(-50%)",
            display:"flex",flexDirection:"column",alignItems:"center",gap:1,
            pointerEvents:"none",
          }}>
            <span style={{fontSize:13,fontWeight:700,color:"rgba(255,255,255,0.92)",letterSpacing:0.2,whiteSpace:"nowrap"}}>
              {(()=>{ const t=tabs.find(t=>t.id===activeTab); return t?.label||"Vista360"; })()}
            </span>
            <span style={{fontSize:10,color:"rgba(79,124,255,0.8)",fontWeight:500,letterSpacing:0.4}}>
        ...
        {/* ── Capa 2: Pill tab bar con scroll ── */}
        <div style={{
          ...
          overflowX:"auto",scrollbarWidth:"none",gap:3,
          position:"relative",
        }}>
          <div style={{position:"absolute",top:0,left:0,right:0,height:1,background:"linear-gradient(90deg,transparent,rgba(155,111,255,0.2),transparent)",pointerEvents:"none",borderRadius:"16px 16px 0 0"}}/>
          {tabs.filter(t=>t.id!=="perfil").map(t=>{
            ...
            return(
              <button key={t.id} onClick={()=>handleTabClick(t.id)} style={{
                ...
                background:active
                  ?"linear-gradient(135deg,rgba(79,124,255,0.22) 0%,rgba(123,95,255,0.14) 100%)"
                  :"transparent",
                border:active?"1px solid rgba(79,124,255,0.3)":"1px solid transparent",
                borderRadius:11,cursor:"pointer",
                color:active?"#FFFFFF":"rgba(255,255,255,0.35)",
                transition:"all 0.16s ease",
                boxShadow:active?"0 2px 14px rgba(79,124,255,0.18),inset 0 1px 0 rgba(255,255,255,0.08)":"none",
                ...
                <span style={{flexShrink:0,display:"flex",alignItems:"center",opacity:active?1:0.45,transform:"scale(0.74)",transformOrigin:"center",transition:"opacity 0.16s"}}>
                  {ICONS[t.id]||ICONS.dashboard}
                </span>
                <span style={{fontSize:12,fontWeight:active?700:500,letterSpacing:active?0.1:0,color:active?"#fff":"rgba(255,255,255,0.38)",transition:"all 0.16s"}}>
                  {t.label}
                </span>
              </button>
            );
      ...
      <div style={{
        ...
        borderTop:"1px solid rgba(79,124,255,0.09)",
        borderLeft:"1px solid rgba(79,124,255,0.09)",
        borderRight:"1px solid rgba(79,124,255,0.09)",
        borderBottom:"none",
        ...
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"20px 20px",paddingBottom:"calc(env(safe-area-inset-bottom) + 80px)",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
