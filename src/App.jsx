...
function HeroCard({ panalesLibres, contratos = [], setTab = () => {} }) {
  ...
  return (
    <div style={{
      ...
      borderBottomLeftRadius: 28, borderBottomRightRadius: 28,
      overflow: "hidden",
      background: "linear-gradient(180deg, #0E1A3B 0%, #0E1A3B 55%, #0B1430 100%)",
      color: "#fff",
      boxShadow: "0 18px 40px -28px rgba(8,14,40,0.55)",
    }}>
      <div aria-hidden style={{ position:"absolute", inset:0, pointerEvents:"none", overflow:"hidden", borderBottomLeftRadius:28, borderBottomRightRadius:28 }}>
  ...
  if (!authReady) {
    return (
      <div style={{
        ...
        <div style={{ width: 28, height: 28, border: "3px solid rgba(255,255,255,0.15)", borderTopColor: "#4F7CFF", borderRadius: "50%", animation: "spin .7s linear infinite" }}/>
      </div>
    );
  }
...
export default function App() {
  ...
  return (
    <>
      ...
      {/* Pantalla de login: se muestra en cuanto termina el splash y no hay usuario */}
      {!splash && !user && (
        <LoginScreen onLoginSuccess={(u) => setUser(u)} authReady={authReady}/>
      )}
