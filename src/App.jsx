    ...
    <div style={{ background: "#F2F4F8", margin: "-20px -16px", minHeight: "100%", paddingBottom: "calc(120px + env(safe-area-inset-bottom))" }}>
      ...
      <div style={{ margin: "0 16px 8px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
          <div>
            <div style={{ fontSize: 15, fontWeight: 800, color: "#0F172A" }}>Leads</div>
          ...
          <button onClick={openNew} style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "#0F172A", border: "none", borderRadius: 50, padding: "10px 18px", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", touchAction: "manipulation", fontFamily: "inherit" }}>
        ...
        {[
          ...
          return (
            <div key={estado} style={{ marginBottom: 8 }}>
              ...
              {grupo.map(p => (
                <div key={p.id} onClick={() => openEdit(p)} style={{ background: "#0F172A", borderRadius: 16, padding: "14px 16px", marginBottom: 7, display: "flex", alignItems: "center", gap: 12, cursor: "pointer", touchAction: "manipulation" }}>
        ...
        {pros.length === 0 && (
          <div style={{ background: "#0F172A", borderRadius: 20, padding: "28px 20px", textAlign: "center" }}>
...
function Capital({ paneles, contratos, gastos, proveedores }) {
  ...
  const CARD = { background: "#0F172A", borderRadius: 20, padding: "22px 20px" };
  ...
  return (
    <div style={{ background: "#F8F9FB", margin: "-20px -16px", minHeight: "100%", paddingBottom: "calc(120px + env(safe-area-inset-bottom))" }}>
      ...
      {(() => {
        ...
        return (
          <div style={{ background: "#0F172A", borderRadius: 20, margin: "12px 16px 0", padding: "20px 18px" }}>
