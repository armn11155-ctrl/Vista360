    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
        html,body,#root{margin:0;padding:0;background:#F2F4F8;height:100%;min-height:100%;overscroll-behavior-y:none;-webkit-text-size-adjust:100%}
      ...
      <div style={{ width: "100%", position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
