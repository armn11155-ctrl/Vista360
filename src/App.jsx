  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",height:"100dvh",width:"100%",color:C.text,overflow:"hidden",position:"relative"}}>
      ...
      <div style={{
        ...
        {/* Right side: solo perfil sin notif */}
        <div style={{flexShrink:0,display:"flex",alignItems:"center",paddingLeft:8,borderLeft:"1px solid rgba(79,124,255,0.12)",marginLeft:4}}>
