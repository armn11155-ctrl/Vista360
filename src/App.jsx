...
export default function App() {
  ...
  useEffect(() => {
    // Safety: si Firebase no responde en 5s, liberar splash de todas formas
    const safetyAuth = setTimeout(() => setAuthReady(true), 5000);
    const unsub = onAuthStateChanged(auth, (u) => {
      clearTimeout(safetyAuth);
    ...
    return () => { clearTimeout(safetyAuth); unsub(); };
  }, []);
