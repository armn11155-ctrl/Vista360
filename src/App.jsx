...
function LoginScreen({ onLoginSuccess }) {
  ...
  return (
    <div style={{
      position: "fixed", top: 0, left: 0, right: 0, height: "var(--app-h, 100dvh)",
...
export default function App() {
  ...
  return (
    <>
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, left: 0, right: 0, height: "var(--app-h, 100dvh)", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", overscrollBehavior: "none" }}>
