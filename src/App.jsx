  ...
  <div style={{paddingBottom:24}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:16}}>
      ...
      <div style={{
        ...
        <div style={{width:34,height:34,borderRadius:10,background:"rgba(59,130,246,0.15)",border:"1px solid rgba(59,130,246,0.3)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 8px"}}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
        </div>
        <div style={{fontSize:11,color:"rgba(255,255,255,0.45)",textTransform:"uppercase",letterSpacing:0.8,marginBottom:4,fontWeight:700}}>Cobrado este mes</div>
        <div style={{fontSize:20,fontWeight:900,color:"#60A5FA",letterSpacing:"-0.5px"}}>{fmt(ingMes)}</div>
        <div style={{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:4}}>{contratos.filter(c=>!c.deleted&&c.pagosMeses?.[mesKey]===true).length} pagos confirmados</div>
      </div>

      {/* Paneles ocupados */}
      <div style={{
        background:"linear-gradient(145deg,rgba(14,24,42,0.95),rgba(8,14,26,0.98))",
        border:`1px solid ${ocupados>0?"rgba(239,68,68,0.30)":"rgba(59,130,246,0.25)"}`,
        borderRadius:16,padding:"16px 12px",textAlign:"center",
        boxShadow:"0 4px 20px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.04)",
        position:"relative",overflow:"hidden",
      }}>
        <div style={{width:34,height:34,borderRadius:10,background:ocupados>0?"rgba(239,68,68,0.15)":"rgba(59,130,246,0.15)",border:`1px solid ${ocupados>0?"rgba(239,68,68,0.3)":"rgba(59,130,246,0.3)"}`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 8px"}}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={ocupados>0?"#F87171":"#60A5FA"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
        </div>
        <div style={{fontSize:11,color:"rgba(255,255,255,0.45)",textTransform:"uppercase",letterSpacing:0.8,marginBottom:4,fontWeight:700}}>Paneles ocupados</div>
        <div style={{fontSize:28,fontWeight:900,color:ocupados>0?"#F87171":"#60A5FA",letterSpacing:"-1px"}}>{ocupados}</div>
        <div style={{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:4}}>{panelLibres} libre{panelLibres!==1?"s":""} · {totalPaneles} total</div>
      </div>
      }}>
      ...
      <div style={{
        ...
        <div style={{width:34,height:34,borderRadius:10,background:"rgba(248,113,113,0.15)",border:"1px solid rgba(248,113,113,0.35)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 8px"}}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F87171" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        </div>
        ...
        <div style={{fontSize:20,fontWeight:900,color:"#F87171",letterSpacing:"-0.5px"}}>{fmt(cobPendiente)}</div>
        <div style={{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:4}}>{contratos.filter(c=>!c.deleted&&!c.pagosMeses?.[mesKey]&&c.inicio?.slice(0,7)<=mesKey&&c.fin?.slice(0,7)>=mesKey).length} contratos pendientes</div>
      </div>
      ...
      <div style={{
        ...
        <div style={{width:34,height:34,borderRadius:10,background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 8px"}}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(200,215,255,0.7)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        </div>
        ...
        <div style={{fontSize:28,fontWeight:900,color:"rgba(220,235,255,0.9)",letterSpacing:"-1px"}}>{vence7}</div>
        <div style={{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:4}}>Próximos 30 días</div>
      </div>
    </div>
    ...
    <div>
      ...
      {insights.length>0&&(
        <CapCard style={{padding:"18px 20px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {insights.map((ins,i)=>(
              <div key={i} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 12px",borderRadius:12,background:ins.color==="#60A5FA"?"rgba(59,130,246,0.12)":"rgba(239,68,68,0.12)",border:`1px solid ${ins.color==="#60A5FA"?"rgba(59,130,246,0.22)":"rgba(239,68,68,0.25)"}`}}>
                <span style={{fontSize:18,flexShrink:0}}>{ins.icon}</span>
                <span style={{fontSize:13,fontWeight:600,color:ins.color==="#60A5FA"?"#60A5FA":"#F87171",lineHeight:1.4}}>{ins.text}</span>
              </div>
            ))}
          </div>
        </CapCard>
