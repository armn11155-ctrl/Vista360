...
function Dashboard({clientes,contratos,paneles,setTab}){
  ...
  const IconCal=()=>(
    <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
      <defs>
        <linearGradient id="gCalBody" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#6D28D9"/><stop offset="1" stopColor="#4C1D95"/>
        </linearGradient>
        <linearGradient id="gCalHeader" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#7C3AED"/>
        </linearGradient>
        <linearGradient id="gCalShadow" x1="0" y1="0" x2="0" y2="1">
          <stop stopColor="#3B0D8C" stopOpacity="0.7"/><stop offset="1" stopColor="#1E0A50" stopOpacity="0.9"/>
        </linearGradient>
        <filter id="calGlow">
      ...
      {/* Shadow/depth layer */}
      <rect x="8" y="11" width="36" height="36" rx="7" fill="url(#gCalShadow)" transform="rotate(-4 26 26)" opacity="0.5"/>
      {/* Body — slightly tilted */}
      <rect x="7" y="9" width="36" height="36" rx="7" fill="url(#gCalBody)" transform="rotate(-3 26 26)" filter="url(#calGlow)"/>
      {/* Header strip */}
      <rect x="7" y="9" width="36" height="13" rx="7" fill="url(#gCalHeader)" transform="rotate(-3 26 26)"/>
      <rect x="7" y="16" width="36" height="6" fill="url(#gCalHeader)" transform="rotate(-3 26 26)"/>
      {/* Ring posts */}
      <rect x="18" y="6" width="4" height="8" rx="2" fill="#A78BFA" transform="rotate(-3 26 26)"/>
      <rect x="30" y="6" width="4" height="8" rx="2" fill="#A78BFA" transform="rotate(-3 26 26)"/>
      {/* Grid dots */}
      <rect x="11" y="26" width="4" height="4" rx="1" fill="#C4B5FD" opacity="0.7" transform="rotate(-3 26 26)"/>
      <rect x="18" y="26" width="4" height="4" rx="1" fill="#C4B5FD" opacity="0.7" transform="rotate(-3 26 26)"/>
      <rect x="25" y="26" width="4" height="4" rx="1" fill="#C4B5FD" opacity="0.7" transform="rotate(-3 26 26)"/>
      <rect x="11" y="33" width="4" height="4" rx="1" fill="#C4B5FD" opacity="0.5" transform="rotate(-3 26 26)"/>
      <rect x="18" y="33" width="4" height="4" rx="1" fill="#C4B5FD" opacity="0.5" transform="rotate(-3 26 26)"/>
      {/* Check circle — bottom right, prominent */}
      <circle cx="39" cy="39" r="10" fill="#1E0A50" transform="rotate(-3 26 26)"/>
      <circle cx="39" cy="39" r="9" fill="#7C3AED" transform="rotate(-3 26 26)" style={{filter:"drop-shadow(0 0 6px rgba(139,92,246,0.9))"}}/>
      <circle cx="39" cy="39" r="7.5" fill="#8B5CF6" transform="rotate(-3 26 26)"/>
      <path d="M35 39 L37.5 41.5 L43 36.5" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" transform="rotate(-3 26 26)" style={{filter:"drop-shadow(0 0 3px rgba(255,255,255,0.8))"}}/>
    </svg>
  );
  ...
  return(<div style={{paddingBottom:32,display:"flex",flexDirection:"column",gap:0}}>
    ...
    <div style={{marginBottom:16,borderRadius:22,border:"1px solid rgba(109,40,217,0.35)",position:"relative",overflow:"hidden",boxShadow:"0 12px 60px rgba(4,0,20,0.8),0 0 0 1px rgba(139,92,246,0.1)",minHeight:190,background:"#060818"}}>
      ...
      <svg style={{position:"absolute",bottom:0,left:0,width:"100%",pointerEvents:"none"}} viewBox="0 0 500 110" preserveAspectRatio="none">
        <defs>
          <linearGradient id="mtn1" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#1A1040" stopOpacity="0.85"/>
            <stop offset="100%" stopColor="#0A0820" stopOpacity="1"/>
          </linearGradient>
          <linearGradient id="mtn2" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#120C38" stopOpacity="0.95"/>
            <stop offset="100%" stopColor="#080618" stopOpacity="1"/>
          </linearGradient>
          <filter id="mtnBlur"><feGaussianBlur stdDeviation="1.5"/></filter>
        </defs>
        {/* Back range — softer, blurred */}
        <polygon points="0,110 0,75 45,35 90,65 140,22 200,58 255,15 310,52 365,28 420,55 480,32 500,42 500,110" fill="url(#mtn1)" filter="url(#mtnBlur)"/>
        {/* Front range — sharper */}
        <polygon points="0,110 0,92 55,70 100,85 150,58 200,78 250,50 300,72 350,55 400,74 450,62 500,70 500,110" fill="url(#mtn2)"/>
      </svg>

      {/* === ANTENNA — sitting on mountains === */}
      <div style={{position:"absolute",right:18,bottom:0,zIndex:3}}>
        <svg width="138" height="160" viewBox="0 0 138 160" fill="none">
          <defs>
            <radialGradient id="antGlow" cx="50%" cy="80%" r="50%">
              <stop offset="0%" stopColor="#7C3AED" stopOpacity="0.7"/>
              <stop offset="50%" stopColor="#4C1D95" stopOpacity="0.3"/>
              <stop offset="100%" stopColor="#4C1D95" stopOpacity="0"/>
            </radialGradient>
            <radialGradient id="dishR" cx="35%" cy="28%" r="70%">
              <stop offset="0%" stopColor="#E8F4FF"/>
              <stop offset="30%" stopColor="#C8DEFF"/>
              <stop offset="70%" stopColor="#7AAAE0"/>
              <stop offset="100%" stopColor="#3060A0"/>
            </radialGradient>
            <radialGradient id="dishShine2" cx="28%" cy="22%" r="48%">
              <stop offset="0%" stopColor="white" stopOpacity="0.55"/>
              <stop offset="100%" stopColor="white" stopOpacity="0"/>
            </radialGradient>
            <linearGradient id="stemAnt" x1="0" y1="0" x2="0" y2="1">
              <stop stopColor="#9DC8F8"/><stop offset="1" stopColor="#1E3A6E"/>
            </linearGradient>
            <linearGradient id="baseAnt" x1="0" y1="0" x2="0" y2="1">
              <stop stopColor="#2A4880"/><stop offset="1" stopColor="#0C1A38"/>
            </linearGradient>
            <filter id="dishGlow">
          ...
          {/* Purple ground glow */}
          <ellipse cx="69" cy="152" rx="52" ry="10" fill="url(#antGlow)"/>

          {/* Signal rings — emanating from dish feed */}
          <ellipse cx="95" cy="52" rx="18" ry="6" stroke="rgba(167,139,250,0.22)" strokeWidth="1.5" fill="none" transform="rotate(-18 95 52)"/>
          <ellipse cx="95" cy="52" rx="28" ry="9" stroke="rgba(167,139,250,0.14)" strokeWidth="1.2" fill="none" transform="rotate(-18 95 52)"/>
          <ellipse cx="95" cy="52" rx="40" ry="13" stroke="rgba(167,139,250,0.08)" strokeWidth="1" fill="none" transform="rotate(-18 95 52)"/>

          {/* Base platform */}
          <rect x="52" y="128" width="34" height="7" rx="3.5" fill="url(#baseAnt)"/>
          <rect x="38" y="133" width="62" height="10" rx="5" fill="url(#baseAnt)"/>
          <rect x="30" y="141" width="78" height="11" rx="5.5" fill="url(#baseAnt)" opacity="0.8"/>

          {/* Vertical stem */}
          <rect x="65" y="90" width="8" height="42" rx="4" fill="url(#stemAnt)"/>

          {/* Arm to feed horn */}
          <line x1="69" y1="90" x2="95" y2="52" stroke="#9DC8F8" strokeWidth="3" strokeLinecap="round"/>

          {/* Dish */}
          <ellipse cx="69" cy="78" rx="50" ry="23" fill="url(#dishR)" transform="rotate(-14 69 78)" filter="url(#dishGlow)"/>
          {/* Dish rings */}
          <ellipse cx="69" cy="78" rx="37" ry="16" stroke="rgba(255,255,255,0.32)" strokeWidth="1" fill="none" transform="rotate(-14 69 78)"/>
          <ellipse cx="69" cy="78" rx="23" ry="9" stroke="rgba(255,255,255,0.25)" strokeWidth="0.8" fill="none" transform="rotate(-14 69 78)"/>
          <ellipse cx="69" cy="78" rx="11" ry="4.5" stroke="rgba(255,255,255,0.2)" strokeWidth="0.7" fill="none" transform="rotate(-14 69 78)"/>
          {/* Shine */}
          <ellipse cx="57" cy="70" rx="16" ry="7" fill="url(#dishShine2)" transform="rotate(-14 57 70)"/>
          {/* Rim */}
          <ellipse cx="69" cy="78" rx="50" ry="23" stroke="rgba(147,197,253,0.75)" strokeWidth="2" fill="none" transform="rotate(-14 69 78)"/>

          {/* Feed horn */}
          <circle cx="95" cy="52" r="5.5" fill="#0A1E3A"/>
          <circle cx="95" cy="52" r="3.5" fill="#1E4080"/>
          <circle cx="95" cy="52" r="2.2" fill="#60A5FA"/>
          <circle cx="95" cy="52" r="1" fill="white"/>

          {/* Purple glow halo around dish */}
          <ellipse cx="69" cy="78" rx="54" ry="25" stroke="rgba(139,92,246,0.35)" strokeWidth="3" fill="none" transform="rotate(-14 69 78)" style={{filter:"blur(2px)"}}/>
        </svg>
      </div>

      {/* === CONTENT === */}
      <div style={{position:"relative",zIndex:4,padding:"24px 22px 22px"}}>
        <div style={{maxWidth:"calc(100% - 145px)"}}>
    ...
    {(()=>{
      ...
      return(
        <div style={{marginBottom:16,padding:"20px 20px",background:"linear-gradient(135deg,#050E09 0%,#071510 40%,#091A12 70%,#050D09 100%)",borderRadius:22,border:"1px solid rgba(16,185,129,0.22)",boxShadow:"0 4px 36px rgba(0,0,0,0.7),inset 0 1px 0 rgba(110,231,183,0.06)"}}>
    ...
    <div style={{marginBottom:16,padding:"22px 20px",background:"linear-gradient(145deg,#1A0D4E 0%,#130A3A 35%,#0E0828 65%,#090620 100%)",borderRadius:22,border:"1px solid rgba(139,92,246,0.38)",overflow:"hidden",boxShadow:"0 6px 40px rgba(109,40,217,0.28),0 0 0 1px rgba(139,92,246,0.08),inset 0 1px 0 rgba(167,139,250,0.12)"}}>
      ...
      <button onClick={()=>setTab("contratos")} style={{width:"100%",padding:"15px",background:"linear-gradient(90deg,#5B21B6 0%,#7C3AED 30%,#8B5CF6 55%,#4F46E5 80%,#3B3FE8 100%)",border:"none",borderRadius:14,color:"#fff",fontWeight:700,fontSize:15,cursor:"pointer",boxShadow:"0 4px 28px rgba(109,40,217,0.7),0 0 48px rgba(139,92,246,0.25),inset 0 1px 0 rgba(255,255,255,0.2),inset 0 -1px 0 rgba(0,0,0,0.2)",letterSpacing:0.3,position:"relative",overflow:"hidden"}}>
        <span style={{position:"relative",zIndex:1}}>Ver contratos →</span>
        <div style={{position:"absolute",top:"10%",left:"20%",width:"60%",height:"40%",background:"radial-gradient(ellipse,rgba(255,255,255,0.18) 0%,transparent 70%)",pointerEvents:"none"}}/>
      </button>
    </div>
...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"linear-gradient(135deg,#030711 0%,#050A18 30%,#080620 60%,#03070F 100%)",height:"100dvh",color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>

      {/* ── SIDEBAR ── */}
      <aside style={{
        width:176,flexShrink:0,
        background:"linear-gradient(180deg,#050818 0%,#060720 40%,#040614 75%,#03050F 100%)",
