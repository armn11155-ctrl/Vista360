...
export default function App() {
  ...
  useEffect(() => {
    ...
    // 2. Bloquear touchmove del documento SOLO fuera de contenedores scrollables
    const blockDocumentScroll = (e) => {
      let el = e.target;
      while (el && el !== document.body) {
        if (el.dataset && el.dataset.scroll !== undefined) return; // está en scrollable → OK
        el = el.parentElement;
      }
      e.preventDefault(); // fuera de scrollable → bloquear bounce
    };
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}
        html{margin:0;padding:0;background:#0A0F1E;width:100%;height:100%;height:100vh;height:100dvh;overflow:hidden;-webkit-text-size-adjust:100%;overscroll-behavior:none}
        body{margin:0;padding:0;background:#0A0F1E;width:100%;height:100%;height:100vh;height:100dvh;overflow:hidden;overscroll-behavior:none;position:fixed;top:0;left:0;right:0;bottom:0;-webkit-text-size-adjust:100%;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
        #root{width:100%;height:100%;overflow:hidden;position:fixed;top:0;left:0;right:0;bottom:0;background:#0A0F1E}
        ::-webkit-scrollbar{display:none}
        /* Anti-bounce: todos los scrollables internos */
        [data-scroll]{overscroll-behavior:none!important;overscroll-behavior-y:none!important;scroll-snap-type:none}
        ...
        *{overscroll-behavior:none!important}
        ...
        html,body,#root{background:#0A0F1E!important}
      ...
      {!splash && !!user && <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", overscrollBehavior: "none" }}>
        ...
        <div
          ref={scrollRef}
          data-scroll
          style={{ flex: 1, minHeight: 0, overflowY: "scroll", overflowX: "hidden", overscrollBehavior: "none", overscrollBehaviorY: "none", WebkitOverflowScrolling: "touch", touchAction: "pan-y" }}
        >
