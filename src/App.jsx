  ...
  return (
    <div style={{ background: "#F2F4F8", margin: "-20px -16px", minHeight: "100%", paddingBottom: "calc(120px + env(safe-area-inset-bottom))" }}>
      ...
      <div style={{ padding: "14px 16px", background: "#fff", borderBottom: "1px solid #E5E7EB" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, background: "#F8FAFC", border: "1px solid #E5E7EB", borderRadius: 14, padding: "11px 14px" }}>
          ...
          <input value={buscar} onChange={e => { setBuscar(e.target.value); setPage(1); }}
            ...
            style={{ flex: 1, border: "none", outline: "none", fontSize: 14, color: "#0F1729", background: "transparent", fontFamily: "inherit" }}/>
      ...
      {/* ── FILTROS ── */}
      <div style={{ display: "flex", gap: 7, padding: "10px 16px 10px", background: "#fff", borderBottom: "1px solid #E5E7EB", overflowX: "auto" }}>
        {filters.map(f => {
      ...
      <div style={{ padding: "10px 16px", display: "flex", flexDirection: "column", gap: 8 }}>
        {paginated.length === 0 ? (
          <div style={{ background: "#fff", borderRadius: 20, padding: "48px 20px", textAlign: "center", border: "1px solid #E5E7EB" }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: "#0F1729", marginBottom: 12 }}>Sin resultados</div>
              ...
              <div style={{ display: "flex" }}>
                ...
                <div style={{ flex: 1, padding: "14px 14px 12px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 11, marginBottom: 10 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 15, fontWeight: 700, color: "#0F1729", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{r.empresa}</div>
      ...
      {/* ── CTA ── */}
      <div style={{ margin: "0 16px 8px", background: "#0F172A", borderRadius: 20, padding: "18px", display: "flex", alignItems: "center", gap: 14 }}>
        <div style={{ width: 46, height: 46, borderRadius: 14, background: "rgba(37,99,235,0.2)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="1.8" strokeLinecap="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>
        </div>
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: "#fff", marginBottom: 3 }}>Agregar prospectos</div>
          <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)" }}>10 nuevos puede aumentar tus ingresos un 30%.</div>
        </div>
        <button onClick={openNew} style={{ background: "#2563EB", border: "none", borderRadius: 50, padding: "9px 16px", color: "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer", touchAction: "manipulation", fontFamily: "inherit", flexShrink: 0 }}>Agregar</button>
      </div>
...
function Historico({contratos,setContratos,paneles,clientes,onModalChange}){
  ...
  return(<div>
    ...
    {/* ── CABECERA DARK ── */}
    <div style={{ background:"linear-gradient(135deg,#0A0F1A,#0F172A)", margin:"-20px -16px 0", padding:"20px 20px 0", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
    ...
    {lista.length===0 ? (
      <div style={{ padding:"60px 20px", textAlign:"center" }}>
        ...
        <div style={{ fontSize:14, fontWeight:600, color:"#0F1729", marginBottom:4 }}>No hay registros</div>
                          ...
                          <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:12, marginBottom:10 }}>
                            <div style={{ flex:1, minWidth:0 }}>
                              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:3 }}>
                                ...
                                <div style={{ fontSize:15, fontWeight:700, color:"#0F1729", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{c.panel.nombre}</div>
                              </div>
                          ...
                          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:12 }}>
                            {[{l:"Inicio",v:fmtF(c.inicio)},{l:"Fin",v:fmtF(c.fin)}].map(({l,v})=>(
                              <div key={l} style={{ background:"#F8FAFC", borderRadius:10, padding:"7px 10px", border:"1px solid #E5E7EB" }}>
                                ...
                                <div style={{ fontSize:12, fontWeight:700, color:"#0F1729" }}>{v}</div>
                              </div>
                            ))}
                          </div>
                          {/* Footer */}
