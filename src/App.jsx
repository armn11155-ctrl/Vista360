...
function ProgressBar({pct,color="#10B981",height=8,bg="rgba(255,255,255,0.08)"}) {
  return (
      ...
      <CapCard style={{padding:"18px 20px",marginBottom:12}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
          {[
            ...
            {label:"Neto libre", value:Math.max(ingresoMensualNeto,0), color:"#fff", bg:"#F8FAFC", icon:"✓"},
          ].map(({label,value,color,bg,icon})=>(
            <div key={label} style={{background:bg,border:"1px solid rgba(255,255,255,0.06)",borderRadius:14,padding:"13px 14px"}}>
      ...
      {insights.length>0&&(
        <CapCard style={{padding:"18px 20px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {insights.map((ins,i)=>(
              <div key={i} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 12px",borderRadius:12,background:ins.color==="#34D399"?"rgba(16,185,129,0.12)":"rgba(239,68,68,0.12)",border:`1px solid ${ins.color==="#34D399"?"rgba(16,185,129,0.25)":"rgba(239,68,68,0.25)"}`}}>
                <span style={{fontSize:18,flexShrink:0}}>{ins.icon}</span>
                <span style={{fontSize:13,fontWeight:600,color:ins.color==="#34D399"?"#34D399":"#F87171",lineHeight:1.4}}>{ins.text}</span>
              </div>
            ))}
          </div>
        </CapCard>
  ...
  const renderLiquidez = () => (
    <div>
      ...
      <CapCard accent={CAP_COLORS.liquidez} style={{padding:"22px 20px",marginBottom:12}}>
        ...
        {/* Caja vs bancos */}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
          <div style={{background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",borderRadius:12,padding:"11px 13px"}}>
      ...
      <CapCard style={{padding:"18px 20px",marginBottom:12}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
          ...
          <button onClick={()=>openAdd("cuentas")} style={{display:"inline-flex",alignItems:"center",gap:5,background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",borderRadius:99,padding:"5px 12px",color:"#10B981",fontSize:11,fontWeight:700,cursor:"pointer",touchAction:"manipulation",fontFamily:"inherit"}}>
            + Agregar
          </button>
        </div>
        {data.cuentas.length===0?(
          ...
          <div key={c.id} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 0",borderBottom:"1px solid rgba(255,255,255,0.07)"}}> 
            <div style={{width:40,height:40,borderRadius:11,background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>🏦</div>
            <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{textAlign:"right",flexShrink:0}}>
              <div style={{fontSize:15,fontWeight:900,color:"#34D399"}}>{fmtS2(c.saldo)}</div>
            </div>
      ...
      <CapCard style={{padding:"18px 20px"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:14}}>
          ...
          <button onClick={()=>{setModal("caja");setForm({caja:String(data.caja)});}} style={{background:"rgba(16,185,129,0.12)",border:"1px solid rgba(16,185,129,0.25)",borderRadius:12,padding:"10px 16px",color:"#34D399",fontSize:12,fontWeight:700,cursor:"pointer",touchAction:"manipulation",fontFamily:"inherit",whiteSpace:"nowrap"}}>
            Actualizar
          </button>
        </div>
      </CapCard>
    ...
    <div>
      ...
      <CapCard style={{padding:"18px 20px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
          ...
          <button onClick={()=>openAdd("activos")} style={{display:"inline-flex",alignItems:"center",gap:5,background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",borderRadius:99,padding:"5px 12px",color:"#34D399",fontSize:11,fontWeight:700,cursor:"pointer",touchAction:"manipulation",fontFamily:"inherit"}}>
            + Agregar
          </button>
        </div>
        {data.activos.length===0?(
      ...
      <div>
        ...
        <CapCard style={{padding:"18px 20px",marginBottom:12}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
            ...
            <button onClick={()=>{setModal("fondos");const f2={};data.fondos.forEach((f,i)=>f2[`pct_${i}`]=f.pct);setForm(f2);}} style={{display:"inline-flex",alignItems:"center",gap:5,background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",borderRadius:99,padding:"5px 12px",color:"#10B981",fontSize:11,fontWeight:700,cursor:"pointer",touchAction:"manipulation",fontFamily:"inherit"}}>
              Ajustar %
            </button>
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
    ...
    <div>
      ...
      <CapCard style={{padding:"18px 20px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
          ...
          <button onClick={()=>openAdd("objetivos")} style={{display:"inline-flex",alignItems:"center",gap:5,background:"rgba(16,185,129,0.10)",border:"1px solid rgba(16,185,129,0.22)",borderRadius:99,padding:"5px 12px",color:"#10B981",fontSize:11,fontWeight:700,cursor:"pointer",touchAction:"manipulation",fontFamily:"inherit"}}>
            + Nuevo
          </button>
        </div>
