...
function SideIcon({id,label,active,onClick}){
  return(
    <button onClick={onClick} title={label} style={{
      ...
      boxShadow:active
        ?"0 4px 20px rgba(109,40,217,0.45), inset 0 1px 0 rgba(255,255,255,0.15)"
        :"none",
      position:"relative",
      overflow:"hidden",
    }}>
      {/* Shine overlay on active */}
      {active&&<div style={{position:"absolute",top:0,left:0,right:0,height:"50%",background:"linear-gradient(180deg,rgba(255,255,255,0.08),transparent)",borderRadius:"13px 13px 0 0",pointerEvents:"none"}}/>}
...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100dvh",color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch"}}>

      {/* ── SIDEBAR ── */}
      <aside style={{
        width:176,flexShrink:0,
        background:"linear-gradient(180deg,#0F1218 0%,#0A0D12 60%,#080B10 100%)",
        ...
        <div style={{position:"absolute",top:0,right:0,width:1,height:"100%",background:"linear-gradient(180deg,transparent 0%,rgba(124,58,237,0.25) 40%,rgba(79,70,229,0.15) 70%,transparent 100%)",pointerEvents:"none",zIndex:1}}/>

        {/* Logo — más grande, con espacio generoso */}
        <div style={{padding:"22px 16px 16px",display:"flex",flexDirection:"column",alignItems:"flex-start",borderBottom:"1px solid rgba(255,255,255,0.05)",marginBottom:6}}>
          <Logo360 width={80}/>
        </div>
        ...
        {/* Notifications + Profile — pegado al fondo, sin espacio negro */}
        <div style={{
          width:"100%",
          borderTop:"1px solid rgba(255,255,255,0.05)",
          paddingBottom:"calc(8px + env(safe-area-inset-bottom))",
          background:"linear-gradient(0deg,#080B10 0%,transparent 100%)",
          flexShrink:0,
        }}>
          {/* Notificaciones */}
          <button style={{
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"20px 20px",paddingBottom:"calc(20px + env(safe-area-inset-bottom))",WebkitOverflowScrolling:"touch"}}>
