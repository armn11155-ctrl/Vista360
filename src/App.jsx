...
function HeroCard({ panalesLibres, contratos = [], setTab = () => {} }) {
  ...
  return (
    <div style={{
      ...
      <div aria-hidden style={{ position:"absolute", inset:0, pointerEvents:"none", overflow:"hidden", borderBottomLeftRadius:28, borderBottomRightRadius:28 }}>
        <div style={{ position:"absolute", top:"50%", right:-80, width:360, height:360, borderRadius:"50%", transform:"translateY(-50%)", background:"radial-gradient(closest-side, rgba(29,107,255,0.30), rgba(29,107,255,0))", filter:"blur(4px)" }}/>
        <div style={{ position:"absolute", top:"50%", left:-120, width:280, height:280, borderRadius:"50%", transform:"translateY(-50%)", background:"radial-gradient(closest-side, rgba(80,140,255,0.14), rgba(0,0,0,0))" }}/>
      </div>
