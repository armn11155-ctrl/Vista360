  ...
  return (
    <>
      ...
      <div style={{ width: "100%", height: "100dvh", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", position: "relative" }}>
        ...
        {/* ── CONTENIDO ── */}
        <div style={{ flex: 1, minHeight: 0, overflowY: "auto", overflowX: "hidden", WebkitOverflowScrolling: "touch", scrollBehavior: "smooth", background: NL.bg }}>
          <div style={{ padding: "20px 16px", paddingBottom: "calc(100px + env(safe-area-inset-bottom))", minHeight: "100%" }}>
            {loading
