        ...
        <div style={{
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: "left" }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#B91C1C" }}>Archivos Eliminados</div>
              {trashCount > 0 && <div style={{ fontSize: 11, color: "#EF4444", marginTop: 1 }}>{trashCount} elemento{trashCount !== 1 ? "s" : ""} en papelera</div>}
            </div>
            {trashCount > 0 && (
              <span style={{ background: "#EF4444", color: "#fff", borderRadius: 99, padding: "2px 8px", fontSize: 11, fontWeight: 700 }}>{trashCount}</span>
            )}
          </button>
        </div>
      </div>
