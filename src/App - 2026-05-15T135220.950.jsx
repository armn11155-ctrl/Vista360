...
function Capital({ paneles, contratos, gastos, proveedores }) {
  ...
  // ── Paleta emerald exclusiva para Capital ──
  const EM = {
    bg:      "#030D06",
    card:    "#061A0E",
    card2:   "#0A2415",
    border:  "rgba(0,210,90,0.12)",
    border2: "rgba(0,210,90,0.22)",
    green:   "#00D26A",
    greenDim:"rgba(0,210,90,0.55)",
    red:     "#FF4D4D",
    white:   "#FFFFFF",
    muted:   "rgba(180,220,195,0.45)",
    text:    "rgba(220,245,230,0.9)",
  };
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 12 }}>
          ...
          <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            <svg width="64" height="36" viewBox="0 0 64 36">
              <path d="M4 34 A28 28 0 0 1 60 34" fill="none" stroke="rgba(0,210,90,0.1)" strokeWidth="6" strokeLinecap="round"/>
        ...
        <div style={{ padding: "20px 18px" }}>
              ...
              {flujo.map(({ mes, ing, eg }) => (
                <div key={mes} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 3, height: "100%", minWidth: 0 }}>
                  <div style={{ flex: 1, width: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end", gap: 3 }}>
                    {ing > 0 && <div style={{ width: "100%", height: `${(ing / maxBar) * 100}%`, minHeight: 5, background: `linear-gradient(180deg, ${EM.green}, rgba(0,210,90,0.6))`, borderRadius: "5px 5px 0 0", boxShadow: `0 0 12px rgba(0,210,90,0.35)` }}/>}
          ...
          {flujo.slice().reverse().map(({ mes, ing, eg, neto }) => (
            <div key={mes} style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 0", borderBottom: `1px solid ${EM.border}` }}>
              <div style={{ width: 40, height: 40, borderRadius: 12, background: neto >= 0 ? "rgba(0,210,90,0.1)" : "rgba(255,77,77,0.1)", border: `1px solid ${neto >= 0 ? EM.border2 : "rgba(255,77,77,0.2)"}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        ...
        <div style={{ padding: "20px 18px" }}>
          ...
          <div style={{ background: EM.card, border: `1px solid ${EM.border}`, borderRadius: 16, padding: "16px 18px", marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: usandoGlobal ? 16 : 0 }}>
              ...
              <button onClick={() => setTasaGlobal(usandoGlobal ? null : 10)} style={{
                ...
                background: usandoGlobal ? "rgba(0,210,90,0.15)" : "transparent",
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {[{ l: "SUNAT 10%", v: 10 }, { l: "5%", v: 5 }, { l: "20%", v: 20 }, { l: "25%", v: 25 }].map(({ l, v }) => (
                    <button key={v} onClick={() => setTasaGlobal(v)} style={{
                      ...
                      background: tasaGlobal === v ? "rgba(0,210,90,0.15)" : "transparent",
          ...
          {costoOriginal > 0 && (
            <div style={{ background: EM.card, border: `1px solid ${EM.border}`, borderRadius: 16, padding: "16px 18px", marginBottom: 20 }}>
              ...
              <div style={{ background: "rgba(0,210,90,0.08)", borderRadius: 99, height: 8, overflow: "hidden", marginBottom: 10 }}>
                <div style={{ height: "100%", borderRadius: 99, width: `${100 - pctPortfolio}%`, background: `linear-gradient(90deg, ${EM.green}, rgba(0,210,90,0.6))`, boxShadow: `0 0 10px rgba(0,210,90,0.4)`, transition: "width .5s ease" }}/>
              </div>
          ...
          {panelDep.filter(p => Number(p.costoInstalacion) > 0).length === 0 ? (
            <div style={{ background: EM.card, border: `1px solid ${EM.border}`, borderRadius: 16, padding: "36px 20px", textAlign: "center" }}>
              <div style={{ width: 48, height: 48, borderRadius: 14, background: "rgba(0,210,90,0.08)", border: `1px solid ${EM.border}`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px", color: EM.muted }}>
            ...
            panelDep.filter(p => Number(p.costoInstalacion) > 0).sort((a, b) => b.pctDesgaste - a.pctDesgaste).map((p, idx, arr) => (
              <div key={p.id} style={{ background: EM.card, border: `1px solid ${EM.border}`, borderRadius: 16, padding: "16px 18px", marginBottom: idx < arr.length - 1 ? 10 : 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                  <div style={{ width: 42, height: 42, borderRadius: 12, background: "rgba(0,210,90,0.08)", border: `1px solid ${EM.border2}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: EM.greenDim }}>
                ...
                <div style={{ background: "rgba(0,210,90,0.06)", borderRadius: 99, height: 6, overflow: "hidden", marginBottom: 7 }}>
                  <div style={{
                    height: "100%", borderRadius: 99, transition: "width .5s ease",
                    width: `${p.pctDesgaste}%`,
                    background: p.pctDesgaste > 75 ? `linear-gradient(90deg,${EM.red},rgba(255,77,77,0.6))` : p.pctDesgaste > 50 ? "linear-gradient(90deg,#FFF,rgba(255,255,255,0.5))" : `linear-gradient(90deg,${EM.green},rgba(0,210,90,0.5))`,
                    boxShadow: p.pctDesgaste <= 50 ? `0 0 8px rgba(0,210,90,0.4)` : "none",
                  }}/>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11 }}>
