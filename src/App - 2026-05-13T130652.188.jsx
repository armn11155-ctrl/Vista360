...
const DRAWER_LOGO_B64 = "data:image/png;base64,";
                        ...
                        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", flexWrap: "wrap" }}>
                          ...
                          {f.pdf_url && (
                            <button onClick={(e) => { e.stopPropagation(); window.open(f.pdf_url, "_blank"); }}
                              style={{
                                background: "linear-gradient(135deg, rgba(37,99,235,0.18) 0%, rgba(79,124,255,0.12) 100%)",
                                border: "1px solid rgba(79,124,255,0.45)",
                                borderRadius: 10, padding: "7px 14px",
                                color: "#7EB3FF", fontSize: 12, fontWeight: 700,
                                cursor: "pointer", display: "flex", alignItems: "center", gap: 7,
                                fontFamily: "inherit",
                                boxShadow: "0 2px 10px rgba(37,99,235,0.18), inset 0 1px 0 rgba(255,255,255,0.06)",
                                transition: "all 0.15s ease",
                              }}>
                              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <rect x="4" y="2" width="12" height="16" rx="1.5" fill="rgba(126,179,255,0.18)" stroke="#7EB3FF" strokeWidth="1.6"/>
                                <path d="M14 2L18 6" stroke="#7EB3FF" strokeWidth="1.6" strokeLinecap="round"/>
                                <rect x="12" y="2" width="6" height="6" rx="0.5" fill="rgba(126,179,255,0.12)" stroke="#7EB3FF" strokeWidth="1.4"/>
                                <line x1="7" y1="11" x2="15" y2="11" stroke="#7EB3FF" strokeWidth="1.2" strokeLinecap="round"/>
                                <line x1="7" y1="14" x2="13" y2="14" stroke="#7EB3FF" strokeWidth="1.2" strokeLinecap="round"/>
                              </svg>
                              Ver PDF
                            </button>
                          )}
  ...
  return (
    <div style={{color:C.text}}>
      ...
      <div style={{marginBottom:20}}>
        ...
        <div style={{fontSize:13,color:"#1E3A8A",marginTop:3}}>
        ...
        {secciones.map(s=>{
          ...
          return (
            <button key={s.id} onClick={()=>setSeccion(s.id)} style={{
              ...
              background:active
                ?"linear-gradient(135deg,rgba(79,124,255,0.45),rgba(99,102,241,0.35))"
                :"rgba(255,255,255,0.11)",
              color:active?"#FFFFFF":"rgba(255,255,255,0.82)",
              fontWeight:active?800:600,fontSize:10.5,transition:"all 0.18s",
              boxShadow:active
                ?"0 4px 20px rgba(79,124,255,0.35), inset 0 1px 0 rgba(255,255,255,0.15)"
                :"inset 0 1px 0 rgba(255,255,255,0.08)",
              outline:active?"1.5px solid rgba(79,124,255,0.55)":"1px solid rgba(255,255,255,0.18)",
              letterSpacing:active?"0.02em":"0",
            }}>
              <div style={{
                width:36,height:36,borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",
                background:active?"rgba(79,124,255,0.30)":"rgba(255,255,255,0.14)",
                color:active?"#AECFFF":"rgba(255,255,255,0.78)",
