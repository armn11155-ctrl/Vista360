...
export default function App() {
  ...
  // ── Forzar viewport-fit=cover en el meta viewport real del index.html ──
  useEffect(() => {
    ...
    // También forzar el root a cubrir todo
  ...
  return (
    <>
      ...
      <div style={{ width: "100%", height: "100%", minHeight: "100dvh", background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden", position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }}>
