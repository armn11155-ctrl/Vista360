...
function Paneles({paneles,setPaneles,contratos,loading,setTab,onModalChange}){
  ...
  const geocodificar=async()=>{
    ...
    }catch(e){ console.warn("[Geocoding] Photon falló, intentando Nominatim:", e); }&format=json&limit=1&countrycodes=pe`,{headers:{"User-Agent":"Vista360/1.0","Accept-Language":"es"}});
      const d=await r.json();
      if(d.length>0){
