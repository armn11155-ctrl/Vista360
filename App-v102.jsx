...
function Dashboard({clientes,contratos,paneles,setTab}){
  ...
  return(<div style={{paddingBottom:8,display:"flex",flexDirection:"column",gap:10}}>
    ...
    {/* ── HERO CARD ── */}
    <div style={{marginBottom:8,borderRadius:22,position:"relative",overflow:"hidden",boxShadow:"0 12px 48px rgba(10,30,120,0.6)",minHeight:200}}>
    ...
    {/* ── INGRESOS ── */}
    <div style={{marginBottom:8,padding:"18px 18px 16px",background:"linear-gradient(145deg,#071510,#050E09)",borderRadius:22,border:"1px solid rgba(16,185,129,0.2)",boxShadow:"0 4px 32px rgba(16,185,129,0.08)",position:"relative",overflow:"hidden"}}>
    ...
    {/* ── PRÓXIMOS A VENCER ── */}
    <div style={{marginBottom:8,padding:"20px 20px",background:"linear-gradient(145deg,#13103A,#0E0C2A)",borderRadius:20,border:"1px solid #2A2060",overflow:"hidden",boxShadow:"0 4px 24px rgba(109,40,217,0.12)"}}>
      {/* Header */}
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#080C14",flex:1,minHeight:0,color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>
      ...
      <div className="main-with-sidebar" style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:"#080C14"}}>
        <main className="main-content" style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px",paddingTop:"calc(env(safe-area-inset-top) + 16px)",paddingBottom:"0px",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth",background:"#080C14"}}>
