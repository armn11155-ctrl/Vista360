...
export default function App(){
  ...
  return(<>
    ...
    <div style={{width:"100%",minHeight:"100dvh",backgroundColor:C.bg,display:"flex",flexDirection:"row",margin:0,padding:0,fontFamily:"'DM Sans',sans-serif",color:C.text}}>
      ...
      <div style={{display:"flex",flexDirection:"column",minHeight:"100dvh",paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"8px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
