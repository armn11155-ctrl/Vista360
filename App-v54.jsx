...
export default function App(){
  ...
  const SideIcon=({t})=>(
    <button onClick={()=>setTab(t.id)} title={t.label} style={{
      ...
      <span style={{fontSize:10,fontWeight:tab===t.id?700:400,letterSpacing:0.2}}>{t.label}</span>
    </button>
  );
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100dvh",color:C.text,display:"flex",overflow:"hidden"}}>
      ...
      <aside style={{
        ...
        <div style={{flex:1,width:"100%",overflowY:"auto",scrollbarWidth:"none"}}>
          {tabs.map(t=><SideIcon key={t.id} t={t}/>)}
        </div>
