    ...
    <>
      ...
      <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 13, fontWeight: 600, color: NL.accent, lineHeight: 1.1, marginBottom: 1 }}>
              Buenos días, Alan Martínez
            </div>
            ...
            <div style={{ fontSize: 11, color: NL.muted, marginTop: 2, lineHeight: 1.1 }}>
              {new Date().toLocaleDateString("es-PE", { weekday: "long", day: "2-digit", month: "long", year: "numeric" }).replace(/^\w/, c => c.toUpperCase())}
            </div>
          </div>
