...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,minHeight:"100vh",color:C.text,display:"flex",flexDirection:"column"}}>
      <nav style={{background:C.surface,borderBottom:`1px solid ${C.border}`,paddingLeft:16,paddingRight:16,paddingTop:8,paddingBottom:0,display:"flex",alignItems:"center",height:56,position:"fixed",top:0,left:0,right:0,zIndex:200,gap:2,overflowX:"auto",scrollbarWidth:"none",WebkitOverflowScrolling:"touch",transform:"translateZ(0)",willChange:"transform"}}>
      ...
      <main style={{flex:1,padding:"20px 16px",paddingTop:"calc(56px + 20px)",maxWidth:1240,width:"100%",margin:"0 auto",boxSizing:"border-box"}}>
        {error&&(
