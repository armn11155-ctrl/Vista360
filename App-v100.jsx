...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#080C14",flex:1,minHeight:0,color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>
      ...
      {/* ── HEADER MÓVIL CON NAV COMPLETO (solo en pantallas pequeñas) ── */}
      <div className="mobile-header" style={{
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 16px 8px"}}>
          <Logo360 width={90}/>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <button onClick={()=>setShowProfile(v=>!v)} style={{background:"none",border:"none",cursor:"pointer",padding:0,display:"flex",alignItems:"center",gap:8}}>
              <div style={{position:"relative"}}>
                <div style={{width:30,height:30,borderRadius:"50%",background:"linear-gradient(135deg,#4F46E5,#7C3AED)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,color:"#fff",border:showProfile?"2px solid #818CF8":"2px solid rgba(79,110,247,0.4)"}}>AM</div>
        ...
        {/* Fila 2: Tabs de navegación — scroll horizontal */}
        <div style={{display:"flex",alignItems:"center",overflowX:"auto",WebkitOverflowScrolling:"touch",scrollbarWidth:"none",padding:"0 8px 6px",gap:2}}>
          {tabs.map(t=>{
            ...
            return(
              <button key={t.id} onClick={()=>{setTab(t.id);setShowProfile(false);}} style={{
                ...
                <span style={{display:"flex",alignItems:"center",justifyContent:"center",width:20,height:20,color:isActive?"#FFFFFF":"rgba(255,255,255,0.4)"}}>
      ...
      <div className="main-with-sidebar" style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:"#080C14"}}>
        <main className="main-content" style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px",paddingTop:"calc(env(safe-area-inset-top) + 16px)",paddingBottom:"16px",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth",background:"#080C14"}}>
