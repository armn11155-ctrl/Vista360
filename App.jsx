    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
        html{margin:0;padding:0;background:#F2F4F8;height:100%;height:-webkit-fill-available;-webkit-text-size-adjust:100%}
        body{margin:0;padding:0;background:#F2F4F8;height:100%;min-height:100vh;min-height:-webkit-fill-available;width:100%;position:fixed;top:0;left:0;overscroll-behavior-y:none;-webkit-text-size-adjust:100%}
      ...
      <div style={{ width: "100vw", height: "100dvh", minHeight: "-webkit-fill-available", position: "fixed", top: 0, left: 0, background: NL.bg, display: "flex", flexDirection: "column", fontFamily: "'DM Sans',sans-serif", color: NL.text, overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 11, color: NL.muted, marginTop: 1 }}>{fechaCap}</div>
          </div>
          ...
          {BOTTOM_TABS_LIST.map(t => {
            ...
            return (
              <button key={t.id} onClick={() => handleTabClick(t.id)} style={{
                ...
                color: active ? NL.accent : NL.muted, padding: "6px 0",
                minHeight: 44,
              }}>
                {BTM_ICONS[t.id]}
                <span style={{ fontSize: 11, fontWeight: active ? 700 : 500 }}>{t.label}</span>
                <div style={{ width: active ? 20 : 4, height: 3, borderRadius: 2, background: active ? NL.accent : "transparent", transition: "width 0.2s ease" }}/>
              </button>
            );
          })}
        </div>
