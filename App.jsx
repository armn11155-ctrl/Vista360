...
export default function App() {
  ...
  useEffect(() => {
    // Safety: si Firebase no responde en 2.5s, mostrar login de todas formas
    const timer = setTimeout(() => { setAuthReady(true); setLoading(false); }, 2500);
  ...
  return (
    <>
      ...
      {splash && <Splash done={() => { setSplash(false); setAuthReady(true); }} isReady={authReady}/>}
