  ...
  return(<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr",gap:14,marginBottom:16}}>
      <Card><SecTit ch="💰 Ingresos del Mes"/>
        <div style={{fontSize:38,fontWeight:800,color:C.white,letterSpacing:"-1px"}}>{fmt(ingMes)}</div>
...
export default function App(){
  ...
  const ICON_B64 = "data:image/png;base64,";

  // Inyectar PWA manifest e iconos dinámicamente
  useEffect(()=>{
    // Icon link tags
    ...
    // Manifest inline
    const manifest={name:'Vista360',short_name:'Vista360',display:'standalone',background_color:'#070C18',theme_color:'#070C18',icons:[{src:ICON_B64,sizes:'192x192',type:'image/png'},{src:ICON_B64,sizes:'512x512',type:'image/png'}]};
    ...
    // Meta tags
    const metas={'apple-mobile-web-app-capable':'yes','apple-mobile-web-app-status-bar-style':'black-translucent','apple-mobile-web-app-title':'Vista360','theme-color':'#070C18'};
  ...
  return(<>
    ...
    <style>{`*{box-sizing:border-box}html,body{margin:0;padding:0;background:#070C18;-webkit-text-size-adjust:100%}::-webkit-scrollbar{width:5px;height:5px}::-webkit-scrollbar-track{background:#070C18}::-webkit-scrollbar-thumb{background:#18253D;border-radius:3px}@keyframes spin{to{transform:rotate(360deg)}}@keyframes pulse{from{opacity:.2}to{opacity:.6}}`}</style>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,minHeight:"100vh",color:C.text,display:"flex",flexDirection:"column"}}>
      <nav style={{background:C.surface,borderBottom:`1px solid ${C.border}`,paddingLeft:16,paddingRight:16,paddingTop:"env(safe-area-inset-top)",display:"flex",alignItems:"center",minHeight:56,position:"fixed",top:0,left:0,right:0,zIndex:200,gap:2,overflowX:"auto",scrollbarWidth:"none",WebkitOverflowScrolling:"touch",transform:"translateZ(0)",willChange:"transform"}}>
      ...
      <main style={{flex:1,padding:"20px 16px",paddingTop:"calc(56px + env(safe-area-inset-top) + 20px)",maxWidth:1240,width:"100%",margin:"0 auto",boxSizing:"border-box"}}>
        {error&&(
