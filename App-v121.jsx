...
function Hoy({clientes,contratos,paneles,gastos,setTab}){
  ...
  <div style={{paddingBottom:24}}>
    ...
    <div style={{marginBottom:16,padding:"18px 20px",background:C.surface,borderRadius:16,border:`1px solid ${C.border}`}}>
      ...
      <div style={{fontSize:22,fontWeight:900,color:C.white,letterSpacing:"-0.5px",marginBottom:8}}>Resumen de hoy</div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{flexShrink:0}}>
            <div style={{fontWeight:900,fontSize:16,color:"#fff",letterSpacing:"-0.5px"}}>VISTA360</div>
          </div>
