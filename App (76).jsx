...
function HeroCard({ panalesLibres, contratos = [], setTab = () => {} }) {
  ...
  return (
    <div style={{
      ...
      <div aria-hidden style={{ position:"absolute", inset:0, pointerEvents:"none", overflow:"hidden", borderBottomLeftRadius:28, borderBottomRightRadius:28 }}>
        <div style={{ position:"absolute", top:"40%", right:-120, width:380, height:380, borderRadius:"50%", background:"radial-gradient(closest-side, rgba(60,130,255,0.22), rgba(60,130,255,0))", filter:"blur(6px)" }}/>
      </div>
