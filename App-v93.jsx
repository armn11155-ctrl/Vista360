...
export default function App(){
  ...
  return(<>
    ...
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,width:"100vw",height:"100dvh",backgroundColor:"#0A0F1E",display:"flex",flexDirection:"row",margin:0,padding:0,overflow:"hidden",fontFamily:"'DM Sans',sans-serif",color:C.text}}>
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100dvh",paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"8px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
