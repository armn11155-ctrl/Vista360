...
function HeroCard({ panalesLibres }) {
  ...
  return (
    <div style={{
      ...
      <HeroWaveArt/>
      <div style={{ position: "relative", zIndex: 2, padding: "18px 20px 18px", display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 180 }}>

        {/* Bloque superior: saludo */}
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ fontSize: 15, color: "rgba(255,255,255,0.92)", fontWeight: 600 }}>{saludo},</span>
          <span style={{ fontSize: 15, color: "#7BB8FF", fontWeight: 800 }}>Alan Martínez</span>
        </div>

        {/* Bloque medio: título */}
        <div style={{ marginTop: 12, marginBottom: 12 }}>
          <div style={{ fontSize: 28, fontWeight: 800, color: "#FFFFFF", lineHeight: 1.05, letterSpacing: "-0.04em" }}>
        ...
        <div>
          <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)", borderRadius: 30, padding: "4px 12px" }}>
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.92)", fontWeight: 600, letterSpacing: 0.3 }}>{fechaCap}</span>
          </div>
        </div>
