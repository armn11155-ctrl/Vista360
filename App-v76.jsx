...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",height:"100dvh",color:C.text,overflow:"hidden",position:"relative"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100dvh",padding:"10px",gap:"10px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
      ...
      <div style={{
        ...
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"20px 20px",paddingBottom:"calc(20px + env(safe-area-inset-bottom))",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
