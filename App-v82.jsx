...
function SideIcon({id,label,active,onClick}){
  return(
    <button onClick={onClick} title={label} style={{
      ...
      background:active
        ?"linear-gradient(135deg,rgba(79,110,247,0.25) 0%,rgba(124,92,252,0.15) 100%)"
        :"transparent",
      border:"none",cursor:"pointer",
      color:active?"#FFFFFF":"rgba(255,255,255,0.38)",
      borderRadius:12,
      transition:"all 0.15s ease",
      boxShadow:active?"inset 0 0 0 1px rgba(79,110,247,0.4)":"none",
      position:"relative",
      marginBottom:2,
    }}>
      {active&&<div style={{position:"absolute",left:0,top:"20%",bottom:"20%",width:3,background:"linear-gradient(180deg,#4F6EF7,#7C5CFC)",borderRadius:"0 3px 3px 0"}}/>}
      <span style={{flexShrink:0,display:"flex",alignItems:"center",color:active?"#818CF8":"rgba(255,255,255,0.38)"}}>
        {ICONS[id]||ICONS.dashboard}
      </span>
      <span style={{fontSize:13,fontWeight:active?700:400,letterSpacing:0.1,whiteSpace:"nowrap",color:active?"#fff":"rgba(255,255,255,0.5)"}}>
        {label}
      </span>
    </button>
  );
  ...
  return(<>
    ...
    <style>{`
      *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
      ...
      @media(max-width:600px){
        ...
        .main-content{
          padding-top:calc(52px + env(safe-area-inset-top) + 12px)!important;
      ...
      @media(min-width:601px){
        ...
        .main-with-sidebar{margin-left:168px!important}
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#080C14",flex:1,minHeight:0,color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>
      ...
      <aside className="sidebar-desktop" style={{
        ...
        {/* Glow lateral */}
        <div style={{position:"absolute",top:0,right:0,width:1,height:"100%",background:"linear-gradient(180deg,transparent,rgba(79,110,247,0.3) 50%,transparent)",pointerEvents:"none"}}/>

        {/* Logo */}
        <div style={{padding:"18px 16px 14px",display:"flex",justifyContent:"flex-start",alignItems:"center",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
          <Logo360 width={100}/>
        </div>

        {/* Nav */}
        <div style={{flex:1,width:"100%",overflowY:"auto",scrollbarWidth:"none",display:"flex",flexDirection:"column",gap:2,padding:"10px 10px 0"}}>
          {tabs.map(t=>(
        ...
        <div style={{padding:"0 10px",borderTop:"1px solid rgba(255,255,255,0.04)",paddingBottom:"calc(10px + env(safe-area-inset-bottom))"}}>
          <button style={{width:"100%",marginTop:8,marginBottom:2,display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"none",border:"none",cursor:"pointer",color:"rgba(255,255,255,0.4)",borderRadius:12}}>
            ...
            <span style={{background:"#7C3AED",color:"#fff",borderRadius:20,padding:"1px 7px",fontSize:11,fontWeight:800}}>3</span>
          </button>

          <button onClick={()=>setShowProfile(v=>!v)} style={{width:"100%",marginBottom:6,display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:showProfile?"rgba(79,110,247,0.12)":"none",border:showProfile?"1px solid rgba(79,110,247,0.25)":"1px solid transparent",cursor:"pointer",borderRadius:12,transition:"all 0.15s"}}>
            <div style={{position:"relative",flexShrink:0}}>
              ...
              <div style={{position:"absolute",bottom:0,right:0,width:10,height:10,borderRadius:"50%",background:"#10B981",border:"2px solid #080C14"}}/>
            </div>
      ...
      <style>{`.mobile-header{display:none!important}@media(max-width:600px){.mobile-header{display:flex!important}}`}</style>
      ...
      <nav className="bottom-nav" style={{
        ...
        background:"linear-gradient(180deg,rgba(8,12,20,0) 0%,#080C14 18px)",
        paddingBottom:"env(safe-area-inset-bottom)",
        flexDirection:"column",
      }}>
        {/* Barra de blur */}
        <div style={{backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",background:"rgba(8,12,20,0.92)",borderTop:"1px solid rgba(255,255,255,0.07)",padding:"8px 0 4px"}}>
          {/* Fila de tabs principales */}
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-around",paddingLeft:4,paddingRight:4}}>
            {tabs.map(t=>{
              ...
              return(
                <button key={t.id} onClick={()=>{setTab(t.id);setShowProfile(false);}} style={{
                  ...
                  {isActive&&<div style={{position:"absolute",top:0,left:"50%",transform:"translateX(-50%)",width:20,height:2,background:"linear-gradient(90deg,#4F6EF7,#7C5CFC)",borderRadius:2}}/>}
                  ...
                  <span style={{fontSize:9,fontWeight:isActive?700:400,letterSpacing:0.3,whiteSpace:"nowrap",color:isActive?"#818CF8":"rgba(255,255,255,0.35)"}}>
                    {t.label}
                  </span>
                </button>
              );
            ...
            <button onClick={()=>setShowProfile(v=>!v)} style={{
              ...
              {showProfile&&<div style={{position:"absolute",top:0,left:"50%",transform:"translateX(-50%)",width:20,height:2,background:"linear-gradient(90deg,#4F6EF7,#7C5CFC)",borderRadius:2}}/>}
              <div style={{position:"relative"}}>
              ...
              <span style={{fontSize:9,fontWeight:showProfile?700:400,color:showProfile?"#818CF8":"rgba(255,255,255,0.35)"}}>Perfil</span>
            </button>
          </div>
        </div>
      </nav>
