...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",position:"fixed",inset:0,color:C.text,overflow:"hidden"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",position:"absolute",inset:0,paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"8px",zIndex:1,boxSizing:"border-box"}}>
