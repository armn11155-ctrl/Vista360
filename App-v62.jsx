...
function Dashboard({clientes,contratos,paneles,setTab}){
  ...
  return(<div style={{paddingBottom:32,display:"flex",flexDirection:"column",gap:0}}>
    ...
    {/* ── HERO CARD ── */}
    <div style={{marginBottom:16,padding:"22px 20px",background:"linear-gradient(135deg,#07112E 0%,#0D1D50 35%,#141F6A 65%,#0A1438 100%)",borderRadius:22,border:"1px solid rgba(59,110,248,0.22)",position:"relative",overflow:"hidden",boxShadow:"0 8px 48px rgba(8,20,100,0.7),inset 0 1px 0 rgba(255,255,255,0.06)"}}>
      {/* Partículas */}
    ...
    {(()=>{
      ...
      return(
        <div style={{marginBottom:16,padding:"20px 20px",background:"linear-gradient(135deg,#041A10 0%,#062C18 40%,#083820 70%,#041510 100%)",borderRadius:22,border:"1px solid rgba(16,185,129,0.28)",boxShadow:"0 4px 36px rgba(16,185,129,0.22),inset 0 1px 0 rgba(110,231,183,0.07)"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16}}>
      {/* Ocupación */}
      <div style={{padding:"16px 12px",background:"linear-gradient(145deg,#0C1D3E,#071020)",borderRadius:22,border:"1px solid rgba(59,130,246,0.25)",display:"flex",flexDirection:"column",alignItems:"center",gap:4,boxShadow:"0 4px 28px rgba(0,0,0,0.55),inset 0 1px 0 rgba(96,165,250,0.06)"}}>
      ...
      {/* Cobro */}
      <div style={{padding:"16px 12px",background:"linear-gradient(145deg,#091E14,#050E0A)",borderRadius:22,border:"1px solid rgba(16,185,129,0.25)",display:"flex",flexDirection:"column",alignItems:"center",gap:4,boxShadow:"0 4px 28px rgba(0,0,0,0.55),inset 0 1px 0 rgba(16,185,129,0.06)"}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:2,alignSelf:"flex-start"}}>
          <IconCard/>
    ...
    {/* ── PRÓXIMOS A VENCER ── */}
    <div style={{marginBottom:16,padding:"22px 20px",background:"linear-gradient(145deg,#120F3A 0%,#0E0B2C 50%,#0A0820 100%)",borderRadius:22,border:"1px solid rgba(139,92,246,0.28)",overflow:"hidden",boxShadow:"0 6px 36px rgba(109,40,217,0.2),inset 0 1px 0 rgba(167,139,250,0.08)"}}>
      {/* Header */}
      ...
      <button onClick={()=>setTab("contratos")} style={{width:"100%",padding:"15px",background:"linear-gradient(90deg,#6D28D9 0%,#8B5CF6 50%,#4F46E5 100%)",border:"none",borderRadius:14,color:"#fff",fontWeight:700,fontSize:15,cursor:"pointer",boxShadow:"0 4px 24px rgba(109,40,217,0.55),inset 0 1px 0 rgba(255,255,255,0.12)",letterSpacing:0.3}}>
        Ver contratos →
      </button>
    </div>
    ...
    {(()=>{
      ...
      const metrics=[
        {type:"ing",label:"Ingresos",value:fmt(ingMes),sub:"Este mes",color:"#10B981",gradId:"mIng",bg:"linear-gradient(145deg,#041A10,#082818)",border:"rgba(16,185,129,0.28)",areaColor:"rgba(16,185,129,0.18)",plot:ingPlot},
        {type:"pan",label:"Paneles activos",value:paneles.filter(p=>p.estado==="Ocupado").length,sub:"Total instalados",color:"#3B82F6",gradId:"mPan",bg:"linear-gradient(145deg,#071428,#0A1A32)",border:"rgba(59,130,246,0.28)",areaColor:"rgba(59,130,246,0.15)",plot:panPlot},
        {type:"con",label:"Contratos activos",value:contratos.filter(c=>dias(c.fin)>0).length,sub:"Este mes",color:"#A78BFA",gradId:"mCon",bg:"linear-gradient(145deg,#100E2A,#0C0A20)",border:"rgba(139,92,246,0.28)",areaColor:"rgba(139,92,246,0.15)",plot:conPlot},
      ];
      return(
        <div style={{padding:"20px 20px",background:"linear-gradient(145deg,#0C1428 0%,#080E1C 100%)",borderRadius:22,border:"1px solid rgba(59,110,248,0.15)",boxShadow:"0 4px 32px rgba(0,0,0,0.45),inset 0 1px 0 rgba(255,255,255,0.03)"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
            {metrics.map(m=>{
              ...
              return(
                <div key={m.label} style={{background:m.bg,border:`1px solid ${m.border}`,borderRadius:16,padding:"14px 8px 0 8px",textAlign:"center",boxShadow:`0 2px 20px rgba(0,0,0,0.45),0 0 0 1px ${m.border},inset 0 1px 0 rgba(255,255,255,0.05)`,overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center"}}>
                  ...
                  <div style={{width:"100%",marginTop:"auto"}}>
                    <svg width="100%" height="28" viewBox="0 0 90 28" preserveAspectRatio="none" style={{display:"block"}}>
                      ...
                      <path d={d} fill="none" stroke={m.color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{filter:`drop-shadow(0 0 3px ${m.color})`}}/>
                    </svg>
                  </div>
                </div>
              );
