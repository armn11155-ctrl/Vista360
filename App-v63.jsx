...
// ── PALETA ───────────────────────────────────────────────────────
const C = {
  bg:"#050919", surface:"#0A1020", card:"#0E1628", border:"#1A2840",
  accent:"#3B6EF8", green:"#10B981", red:"#EF4444", amber:"#F59E0B",
...
const Card   = ({children,style={}})=><div style={{background:"linear-gradient(145deg,#0F1A30 0%,#0A1020 100%)",border:`1px solid rgba(59,110,248,0.18)`,borderRadius:20,padding:22,boxShadow:"0 4px 32px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.04)",...style}}>{children}</div>;
...
function Dashboard({clientes,contratos,paneles,setTab}){
  ...
  return(<div style={{paddingBottom:32,display:"flex",flexDirection:"column",gap:0}}>
    ...
    {/* ── HERO CARD ── */}
    <div style={{marginBottom:16,padding:"24px 22px 22px",background:"linear-gradient(135deg,#030B1F 0%,#06123A 30%,#0C1D60 58%,#08124A 78%,#030B20 100%)",borderRadius:24,border:"1px solid rgba(96,165,250,0.28)",position:"relative",overflow:"hidden",boxShadow:"0 12px 60px rgba(6,18,100,0.8),0 2px 0 rgba(96,165,250,0.15),inset 0 1px 0 rgba(255,255,255,0.08)"}}>
      {/* Nebula background layer */}
      <div style={{position:"absolute",inset:0,background:"radial-gradient(ellipse 80% 60% at 70% 50%,rgba(79,70,229,0.25) 0%,transparent 65%),radial-gradient(ellipse 50% 80% at 85% 20%,rgba(139,92,246,0.18) 0%,transparent 55%),radial-gradient(ellipse 40% 40% at 15% 80%,rgba(37,99,235,0.12) 0%,transparent 60%)",pointerEvents:"none"}}/>
      {/* Mountain silhouette SVG */}
      <svg style={{position:"absolute",bottom:0,left:0,right:0,width:"100%",pointerEvents:"none",opacity:0.55}} viewBox="0 0 400 100" preserveAspectRatio="none" fill="none">
        <defs>
          <linearGradient id="mtnG1" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#0A1855"/><stop offset="1" stopColor="#030B1F"/></linearGradient>
          <linearGradient id="mtnG2" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#061235"/><stop offset="1" stopColor="#030B1F"/></linearGradient>
        </defs>
        <polygon points="0,100 0,70 40,30 80,60 120,20 170,55 210,10 260,50 300,25 350,55 400,35 400,100" fill="url(#mtnG1)"/>
        <polygon points="0,100 0,85 50,60 90,78 130,50 180,72 220,42 270,65 310,48 360,68 400,55 400,100" fill="url(#mtnG2)"/>
      </svg>
      {/* Stars */}
      {[[14,18,0.8],[28,8,0.5],[55,22,0.6],[70,10,0.4],[88,16,0.7],[40,6,0.5],[62,4,0.8]].map(([rx,ry,op],i)=>(
        <div key={i} style={{position:"absolute",top:`${ry}%`,right:`${rx}%`,width:i%2===0?3:2,height:i%2===0?3:2,borderRadius:"50%",background:"rgba(255,255,255,0.9)",opacity:op,boxShadow:`0 0 ${i%2===0?6:4}px rgba(147,197,253,0.8)`}}/>
      ))}
      {/* Aurora streak */}
      <div style={{position:"absolute",top:0,right:"20%",width:"35%",height:"100%",background:"linear-gradient(170deg,transparent 0%,rgba(99,102,241,0.08) 30%,rgba(139,92,246,0.12) 50%,rgba(59,130,246,0.06) 70%,transparent 100%)",transform:"skewX(-8deg)",pointerEvents:"none"}}/>

      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",position:"relative",zIndex:2}}>
        <div style={{flex:1}}>
          <div style={{fontSize:14,color:"rgba(255,255,255,0.7)",fontWeight:500,marginBottom:5,letterSpacing:0.2}}>
            {saludoReal}, <span style={{color:"#7DD3FC",fontWeight:700,textShadow:"0 0 12px rgba(125,211,252,0.6)"}}>Alan</span>! 👋
          </div>
          <div style={{fontSize:34,fontWeight:900,color:"#FFFFFF",letterSpacing:"-1px",lineHeight:1.05,marginBottom:7,textShadow:"0 2px 24px rgba(96,165,250,0.3)"}}>
            Alan Martínez
          </div>
          <div style={{fontSize:13,color:"rgba(255,255,255,0.45)",marginBottom:20,letterSpacing:0.1}}>
            Aquí tienes el resumen de hoy.
          </div>
          <div style={{display:"inline-flex",alignItems:"center",gap:9,background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:30,padding:"8px 16px",backdropFilter:"blur(8px)"}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <rect x="1" y="2" width="12" height="11" rx="2" stroke="#7DD3FC" strokeWidth="1.3" fill="none"/>
              <line x1="1" y1="6" x2="13" y2="6" stroke="#7DD3FC" strokeWidth="1.3"/>
              <line x1="4" y1="1" x2="4" y2="4" stroke="#7DD3FC" strokeWidth="1.3" strokeLinecap="round"/>
              <line x1="10" y1="1" x2="10" y2="4" stroke="#7DD3FC" strokeWidth="1.3" strokeLinecap="round"/>
            </svg>
        ...
        {/* Premium satellite illustration */}
        <div style={{flexShrink:0,marginTop:-8,marginRight:-6,display:"flex",alignItems:"center",justifyContent:"center",position:"relative",width:148,height:148}}>
          {/* Outer glow rings */}
          <div style={{position:"absolute",width:148,height:148,borderRadius:"50%",border:"1px solid rgba(99,102,241,0.15)",animation:"none"}}/>
          <div style={{position:"absolute",width:118,height:118,borderRadius:"50%",border:"1px solid rgba(99,102,241,0.2)"}}/>
          <div style={{position:"absolute",width:88,height:88,borderRadius:"50%",border:"1px solid rgba(99,102,241,0.28)"}}/>
          <div style={{position:"absolute",width:60,height:60,borderRadius:"50%",background:"radial-gradient(circle,rgba(79,70,229,0.45) 0%,transparent 70%)"}}/>
          {/* Dish SVG — rich 3D style */}
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" style={{zIndex:2,filter:"drop-shadow(0 0 22px rgba(147,197,253,0.7)) drop-shadow(0 6px 18px rgba(0,0,60,0.9))"}}>
            <defs>
              <radialGradient id="hDish" cx="35%" cy="28%" r="70%"><stop offset="0%" stopColor="#EBF4FF"/><stop offset="35%" stopColor="#BFD9FF"/><stop offset="75%" stopColor="#6BA3E8"/><stop offset="100%" stopColor="#2A5FA5"/></radialGradient>
              <radialGradient id="hShine" cx="28%" cy="22%" r="48%"><stop offset="0%" stopColor="white" stopOpacity="0.6"/><stop offset="100%" stopColor="white" stopOpacity="0"/></radialGradient>
              <linearGradient id="hStem" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#90C0F8"/><stop offset="1" stopColor="#1E3A6E"/></linearGradient>
              <linearGradient id="hBase" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#2A4A7E"/><stop offset="1" stopColor="#0E1E3A"/></linearGradient>
            </defs>
            {/* Signal rings */}
            <ellipse cx="74" cy="42" rx="26" ry="8" stroke="rgba(147,197,253,0.2)" strokeWidth="1" fill="none" transform="rotate(-15 74 42)"/>
            <ellipse cx="74" cy="42" rx="36" ry="11" stroke="rgba(147,197,253,0.12)" strokeWidth="1" fill="none" transform="rotate(-15 74 42)"/>
            {/* Base */}
            <rect x="52" y="90" width="16" height="5" rx="2.5" fill="url(#hBase)"/>
            <rect x="42" y="93" width="36" height="7" rx="3.5" fill="url(#hBase)"/>
            {/* Stem */}
            <rect x="58" y="65" width="4" height="28" rx="2" fill="url(#hStem)"/>
            <line x1="60" y1="65" x2="74" y2="44" stroke="#90C0F8" strokeWidth="2" strokeLinecap="round"/>
            {/* Dish */}
            <ellipse cx="60" cy="55" rx="38" ry="18" fill="url(#hDish)" transform="rotate(-12 60 55)"/>
            <ellipse cx="60" cy="55" rx="28" ry="12" stroke="rgba(255,255,255,0.35)" strokeWidth="0.8" fill="none" transform="rotate(-12 60 55)"/>
            <ellipse cx="60" cy="55" rx="18" ry="7" stroke="rgba(255,255,255,0.28)" strokeWidth="0.7" fill="none" transform="rotate(-12 60 55)"/>
            <ellipse cx="60" cy="55" rx="9" ry="3.5" stroke="rgba(255,255,255,0.22)" strokeWidth="0.7" fill="none" transform="rotate(-12 60 55)"/>
            {/* Shine */}
            <ellipse cx="50" cy="48" rx="14" ry="6" fill="url(#hShine)" transform="rotate(-12 50 48)"/>
            <ellipse cx="60" cy="55" rx="38" ry="18" stroke="rgba(147,197,253,0.7)" strokeWidth="1.5" fill="none" transform="rotate(-12 60 55)"/>
            {/* Feed horn */}
            <circle cx="74" cy="44" r="4.5" fill="#0A1E3A"/>
            <circle cx="74" cy="44" r="3" fill="#1E4080"/>
            <circle cx="74" cy="44" r="1.8" fill="#60A5FA"/>
            <circle cx="74" cy="44" r="0.9" fill="white"/>
          </svg>
        </div>
      </div>
    </div>
    ...
    {(()=>{
      ...
      return(
        <div style={{marginBottom:16,padding:"22px 20px",background:"linear-gradient(145deg,#080F1E 0%,#0C1530 40%,#101A3A 70%,#080D1C 100%)",borderRadius:22,border:"1px solid rgba(16,185,129,0.3)",boxShadow:"0 8px 48px rgba(0,0,0,0.7),0 0 0 1px rgba(16,185,129,0.08),inset 0 1px 0 rgba(110,231,183,0.1)"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16}}>
      {/* Ocupación */}
      <div style={{padding:"18px 12px",background:"linear-gradient(145deg,#0A1C40 0%,#0C2050 40%,#080D26 100%)",borderRadius:22,border:"1px solid rgba(99,102,241,0.3)",display:"flex",flexDirection:"column",alignItems:"center",gap:4,boxShadow:"0 8px 40px rgba(0,0,0,0.65),0 0 30px rgba(99,102,241,0.08),inset 0 1px 0 rgba(147,197,253,0.1),inset 0 -1px 0 rgba(0,0,0,0.3)"}}>
        ...
        <svg width="120" height="120" viewBox="0 0 120 120">
          ...
          <circle cx="60" cy="60" r="46" fill="none" stroke="url(#gocu2)" strokeWidth="11"
            ...
            style={{filter:"drop-shadow(0 0 10px rgba(99,102,241,0.9)) drop-shadow(0 0 4px rgba(139,92,246,0.6))",transition:"stroke-dasharray 0.6s ease"}}/>
          {/* Punto brillante al inicio del arco */}
          {ocu>0&&<circle cx="60" cy="14" r="5.5" fill="#818CF8" transform={`rotate(${(ocu/100)*360} 60 60)`} style={{filter:"drop-shadow(0 0 6px rgba(129,140,248,1))"}}/>}
      ...
      {/* Cobro */}
      <div style={{padding:"18px 12px",background:"linear-gradient(145deg,#071C14 0%,#092518 40%,#050E0C 100%)",borderRadius:22,border:"1px solid rgba(16,185,129,0.3)",display:"flex",flexDirection:"column",alignItems:"center",gap:4,boxShadow:"0 8px 40px rgba(0,0,0,0.65),0 0 30px rgba(16,185,129,0.08),inset 0 1px 0 rgba(52,211,153,0.1),inset 0 -1px 0 rgba(0,0,0,0.3)"}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:2,alignSelf:"flex-start"}}>
          <IconCard/>
        ...
        <svg width="120" height="120" viewBox="0 0 120 120">
          ...
          {/* Track */}
          <circle cx="60" cy="60" r="46" fill="none" stroke="#0D2B1E" strokeWidth="11"/>
          {/* Progreso con gradiente */}
          <circle cx="60" cy="60" r="46" fill="none" stroke="url(#gcob2)" strokeWidth="11"
            ...
            style={{filter:"drop-shadow(0 0 10px rgba(16,185,129,0.9)) drop-shadow(0 0 4px rgba(6,182,212,0.5))",transition:"stroke-dasharray 0.6s ease"}}/>
          {/* Punto brillante */}
          {cob>0&&<circle cx="60" cy="14" r="5.5" fill="#34D399" transform={`rotate(${(cob/100)*360} 60 60)`} style={{filter:"drop-shadow(0 0 6px rgba(52,211,153,1))"}}/>}
    ...
    {/* ── PRÓXIMOS A VENCER ── */}
    <div style={{marginBottom:16,padding:"22px 20px",background:"linear-gradient(145deg,#0E0B30 0%,#130F42 35%,#0A0825 70%,#08061C 100%)",borderRadius:22,border:"1px solid rgba(139,92,246,0.32)",overflow:"hidden",boxShadow:"0 10px 50px rgba(109,40,217,0.25),0 0 0 1px rgba(139,92,246,0.06),inset 0 1px 0 rgba(196,181,253,0.12),inset 0 -1px 0 rgba(0,0,0,0.3)"}}>
      {/* Ambient glow */}
      <div style={{position:"absolute",top:0,right:0,width:"50%",height:"50%",background:"radial-gradient(ellipse at 80% 20%,rgba(139,92,246,0.12) 0%,transparent 70%)",pointerEvents:"none"}}/>
      {/* Header */}
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18,gap:8,position:"relative"}}>
        <div style={{flex:1}}>
          {prox.length===0?(
            <>
              <div style={{fontSize:15,fontWeight:800,color:"#FFFFFF",marginBottom:7,textShadow:"0 0 20px rgba(167,139,250,0.3)"}}>No tienes contratos próximos a vencer.</div>
              <div style={{fontSize:13,color:"#A78BFA",opacity:0.9,fontWeight:500}}>¡Todo al día, buen trabajo!</div>
            </>
          ):(
            prox.map(c=>(
              <div key={c.id} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid rgba(139,92,246,0.2)"}}>
        ...
        <div style={{flexShrink:0,marginRight:-10,marginBottom:-10}}>
          <svg width="90" height="90" viewBox="0 0 90 90" fill="none">
            <defs>
              <linearGradient id="calBodyG" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#7C3AED"/><stop offset="1" stopColor="#4C1D95"/></linearGradient>
              <linearGradient id="calHeaderG" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#6D28D9"/></linearGradient>
              <filter id="calShadow"><feDropShadow dx="0" dy="6" stdDeviation="8" floodColor="#4C1D95" floodOpacity="0.6"/></filter>
            </defs>
            <ellipse cx="46" cy="84" rx="26" ry="5" fill="#4C1D95" opacity="0.4"/>
            {/* Calendar body */}
            <rect x="10" y="20" width="62" height="56" rx="10" fill="url(#calBodyG)" filter="url(#calShadow)"/>
            {/* Header bar */}
            <rect x="10" y="20" width="62" height="22" rx="10" fill="url(#calHeaderG)"/>
            <rect x="10" y="34" width="62" height="8" fill="url(#calHeaderG)"/>
            {/* Paper area */}
            <rect x="14" y="40" width="54" height="32" rx="6" fill="#EDE9FE" opacity="0.92"/>
            {/* Ring binders */}
            <rect x="26" y="13" width="7" height="14" rx="3.5" fill="#5B21B6"/>
            <rect x="49" y="13" width="7" height="14" rx="3.5" fill="#5B21B6"/>
            <rect x="27" y="14" width="5" height="10" rx="2.5" fill="#7C3AED"/>
            <rect x="50" y="14" width="5" height="10" rx="2.5" fill="#7C3AED"/>
            {/* Day grid dots */}
            {[0,1,2,3,4,5].map(i=>(
              <rect key={i} x={18+i*9} y="48" width="6" height="5" rx="1.5" fill={i===4?"#7C3AED":"#DDD6FE"} opacity={i===4?1:0.7}/>
            ))}
            {[0,1,2,3,4,5].map(i=>(
              <rect key={i} x={18+i*9} y="57" width="6" height="5" rx="1.5" fill="#DDD6FE" opacity="0.5"/>
            ))}
            {/* Checkmark circle */}
            <circle cx="66" cy="68" r="13" fill="#059669"/>
            <circle cx="66" cy="68" r="11" fill="#10B981"/>
            <path d="M60 68 L64 72 L72 62" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      </div>
      <button onClick={()=>setTab("contratos")} style={{width:"100%",padding:"15px",background:"linear-gradient(90deg,#5B21B6 0%,#7C3AED 35%,#8B5CF6 65%,#6D28D9 100%)",border:"none",borderRadius:14,color:"#fff",fontWeight:700,fontSize:15,cursor:"pointer",boxShadow:"0 6px 32px rgba(109,40,217,0.65),0 1px 0 rgba(196,181,253,0.2),inset 0 1px 0 rgba(255,255,255,0.15)",letterSpacing:0.3,position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,background:"linear-gradient(180deg,rgba(255,255,255,0.07) 0%,transparent 100%)",borderRadius:14}}/>
        Ver contratos →
      </button>
    </div>
    ...
    {(()=>{
      ...
      const metrics=[
        {type:"ing",label:"Ingresos",value:fmt(ingMes),sub:"Este mes",color:"#10B981",gradId:"mIng",bg:"linear-gradient(145deg,#041C12,#062016)",border:"rgba(16,185,129,0.32)",areaColor:"rgba(16,185,129,0.18)",plot:ingPlot},
        {type:"pan",label:"Paneles activos",value:paneles.filter(p=>p.estado==="Ocupado").length,sub:"Total instalados",color:"#3B82F6",gradId:"mPan",bg:"linear-gradient(145deg,#07162A,#0A1C36)",border:"rgba(59,130,246,0.32)",areaColor:"rgba(59,130,246,0.15)",plot:panPlot},
        {type:"con",label:"Contratos activos",value:contratos.filter(c=>dias(c.fin)>0).length,sub:"Este mes",color:"#A78BFA",gradId:"mCon",bg:"linear-gradient(145deg,#10102C,#0E0C28)",border:"rgba(139,92,246,0.32)",areaColor:"rgba(139,92,246,0.15)",plot:conPlot},
      ];
      return(
        <div style={{padding:"20px 20px",background:"linear-gradient(145deg,#0A1226 0%,#080C1C 100%)",borderRadius:22,border:"1px solid rgba(59,110,248,0.2)",boxShadow:"0 8px 48px rgba(0,0,0,0.55),0 0 0 1px rgba(59,110,248,0.04),inset 0 1px 0 rgba(255,255,255,0.04)"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
            {metrics.map(m=>{
              ...
              return(
                <div key={m.label} style={{background:m.bg,border:`1px solid ${m.border}`,borderRadius:18,padding:"16px 8px 0 8px",textAlign:"center",boxShadow:`0 6px 32px rgba(0,0,0,0.55),0 0 20px ${m.border.replace("0.28","0.06")},inset 0 1px 0 rgba(255,255,255,0.07),inset 0 -1px 0 rgba(0,0,0,0.25)`,overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center"}}>
                  ...
                  <div style={{width:"100%",marginTop:"auto"}}>
                    <svg width="100%" height="28" viewBox="0 0 90 28" preserveAspectRatio="none" style={{display:"block"}}>
                      ...
                      <path d={d} fill="none" stroke={m.color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{filter:`drop-shadow(0 0 5px ${m.color}) drop-shadow(0 0 2px ${m.color})`}}/>
                    </svg>
                  </div>
                </div>
              );
    ...
    {/* ── GRÁFICA CRECIMIENTO ── */}
    <div style={{marginTop:14,padding:"20px 20px",background:"linear-gradient(145deg,#0A1226 0%,#080C1C 100%)",borderRadius:22,border:"1px solid rgba(59,110,248,0.2)",boxShadow:"0 8px 48px rgba(0,0,0,0.55),inset 0 1px 0 rgba(255,255,255,0.04)"}}>
...
function SideIcon({id,label,active,onClick}){
  return(
    <button onClick={onClick} title={label} style={{
      ...
      boxShadow:active
        ?"0 4px 24px rgba(124,58,237,0.5), inset 0 1px 0 rgba(255,255,255,0.18)"
        :"none",
      position:"relative",
      overflow:"hidden",
    }}>
      {/* Shine overlay on active */}
      {active&&<div style={{position:"absolute",top:0,left:0,right:0,height:"50%",background:"linear-gradient(180deg,rgba(255,255,255,0.1),transparent)",borderRadius:"13px 13px 0 0",pointerEvents:"none"}}/>}
      <span style={{flexShrink:0,display:"flex",alignItems:"center",opacity:active?1:0.65,transition:"opacity 0.18s"}}>
        {ICONS[id]||ICONS.dashboard}
      </span>
      <span style={{fontSize:13,fontWeight:active?700:500,letterSpacing:0.1,whiteSpace:"nowrap"}}>
        {label}
      </span>
    </button>
  );
...
export default function App(){
  ...
  return(<>
    ...
    <style>{`*{box-sizing:border-box;-webkit-tap-highlight-color:transparent}html,body{margin:0;padding:0;background:#070C18;overflow:hidden;height:100%;-webkit-text-size-adjust:100%}::-webkit-scrollbar{display:none}@keyframes spin{to{transform:rotate(360deg)}}@keyframes pulse{from{opacity:.2}to{opacity:.6}}@keyframes ringPulse{0%{opacity:0.15;transform:scale(1)}50%{opacity:0.35}100%{opacity:0.15;transform:scale(1.04)}}@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px)}}@keyframes shimmer{0%{opacity:0.6}50%{opacity:1}100%{opacity:0.6}}`}</style>

    {splash&&<Splash done={()=>setSplash(false)}/>}
    {showConfig&&<ModalConfig onClose={()=>setShowConfig(false)}/>}

    <div style={{fontFamily:"'DM Sans',sans-serif",background:"linear-gradient(135deg,#050919 0%,#080B20 30%,#0D0928 60%,#050912 100%)",height:"100dvh",color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>

      {/* ── SIDEBAR ── */}
      <aside style={{
        width:176,flexShrink:0,
        background:"linear-gradient(180deg,#080D1E 0%,#0A0C1C 40%,#06091A 75%,#050817 100%)",
        ...
        {/* Glow sutil en el borde derecho */}
        <div style={{position:"absolute",top:0,right:0,width:1,height:"100%",background:"linear-gradient(180deg,transparent 0%,rgba(139,92,246,0.45) 40%,rgba(99,70,255,0.3) 70%,transparent 100%)",pointerEvents:"none",zIndex:1}}/>
        ...
        {/* Nav tabs — ocupa todo el espacio disponible */}
        <div style={{flex:1,width:"100%",overflowY:"auto",scrollbarWidth:"none",paddingTop:6,display:"flex",flexDirection:"column",gap:2}}>
          {tabs.map(t=>(
        ...
        {/* Notifications + Profile — pegado al fondo */}
        <div style={{
          width:"100%",
          ...
          <button style={{
            ...
            <span style={{flexShrink:0,display:"flex",alignItems:"center",color:"rgba(255,255,255,0.4)"}}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
              </svg>
            </span>
            <span style={{fontSize:13,fontWeight:500,flex:1,textAlign:"left",color:"rgba(255,255,255,0.55)"}}>Notificaciones</span>
            <span style={{background:"#7C3AED",color:"#fff",borderRadius:20,padding:"2px 7px",fontSize:11,fontWeight:800,minWidth:20,textAlign:"center",boxShadow:"0 0 8px rgba(124,58,237,0.6)"}}>3</span>
          </button>
          ...
          <button onClick={()=>setShowProfile(v=>!v)} style={{
            ...
            background:showProfile?"rgba(124,58,237,0.15)":"none",
            border:showProfile?"1px solid rgba(124,58,237,0.2)":"1px solid transparent",
            ...
            <div style={{flex:1,textAlign:"left",minWidth:0}}>
              <div style={{fontSize:13,fontWeight:700,color:"rgba(255,255,255,0.9)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>Alan Mart...</div>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",paddingTop:"env(safe-area-inset-top)"}}>
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px 16px",paddingTop:16,paddingBottom:"calc(60px + env(safe-area-inset-bottom))",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
