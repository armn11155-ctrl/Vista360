  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "22px 22px 22px", maxWidth: "78%" }}>
        ...
        {/* 2. Todo bajo control */}
        <div style={{ fontSize: 34, fontWeight: 800, color: "#FFFFFF", lineHeight: 1.02, letterSpacing: "-0.035em", marginBottom: 16 }}>
        ...
        {/* 4. Fecha */}
        <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 30, padding: "4px 11px", marginBottom: 4 }}>
