...
export default function App(){
  ...
  return(<>
    ...
    <style>{`*{box-sizing:border-box;-webkit-tap-highlight-color:transparent}html,body{margin:0;padding:0;background:#070C18;overflow:hidden;width:100%;height:100%;-webkit-text-size-adjust:100%}#root{width:100%;height:100%;display:flex;flex-direction:column}::-webkit-scrollbar{display:none}@keyframes spin{to{transform:rotate(360deg)}}@keyframes pulse{from{opacity:.2}to{opacity:.6}}`}</style>

    {splash&&<Splash done={()=>setSplash(false)}/>}
    {showConfig&&<ModalConfig onClose={()=>setShowConfig(false)}/>}

    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100svh",color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative",paddingTop:"env(safe-area-inset-top)",paddingBottom:"env(safe-area-inset-bottom)"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px 16px 24px",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
