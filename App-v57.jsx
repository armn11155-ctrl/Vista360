...
function SideIcon({id,label,active,onClick}){
  return(
    <button onClick={onClick} title={label} style={{
      width:"calc(100% - 16px)",margin:"2px 8px",display:"flex",flexDirection:"row",alignItems:"center",
      gap:10,padding:"11px 12px",
      background:active?"linear-gradient(135deg,#7C3AED,#4F46E5)":"none",
      ...
      <span style={{flexShrink:0,display:"flex",alignItems:"center",opacity:active?1:0.7}}>{ICONS[id]||ICONS.dashboard}</span>
      <span style={{fontSize:13,fontWeight:active?700:500,letterSpacing:0.1,whiteSpace:"nowrap"}}>{label}</span>
    </button>
  );
}
...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100dvh",color:C.text,display:"flex",overflow:"hidden"}}>
      ...
      {/* ── SIDEBAR ── */}
      <aside style={{
        width:172,flexShrink:0,background:"#0D1117",
        ...
        {/* Logo */}
        <div style={{padding:"16px 16px 12px",width:"100%",display:"flex",alignItems:"center",gap:10,borderBottom:"1px solid rgba(255,255,255,0.06)",marginBottom:8}}>
          <Logo360 width={56}/>
        </div>

        {/* Nav tabs */}
        <div style={{flex:1,width:"100%",overflowY:"auto",scrollbarWidth:"none",paddingTop:4}}>
          {tabs.map(t=>(
        ...
        <div style={{width:"100%",borderTop:"1px solid rgba(255,255,255,0.06)",paddingBottom:"env(safe-area-inset-bottom)"}}>
          {/* Notificaciones */}
          <button style={{width:"calc(100% - 16px)",margin:"6px 8px 2px",display:"flex",flexDirection:"row",alignItems:"center",gap:10,padding:"10px 12px",background:"none",border:"none",cursor:"pointer",color:"rgba(255,255,255,0.45)",borderRadius:12,transition:"all 0.15s"}}>
            <span style={{flexShrink:0,display:"flex",alignItems:"center"}}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
            </span>
            <span style={{fontSize:13,fontWeight:500,flex:1,textAlign:"left"}}>Notificaciones</span>
            <span style={{background:"#8B5CF6",color:"#fff",borderRadius:20,padding:"1px 7px",fontSize:11,fontWeight:700,minWidth:20,textAlign:"center"}}>3</span>
          </button>
          {/* User profile */}
          <button onClick={()=>setShowProfile(v=>!v)} style={{width:"calc(100% - 16px)",margin:"2px 8px 8px",display:"flex",flexDirection:"row",alignItems:"center",gap:10,padding:"8px 12px",background:showProfile?"linear-gradient(135deg,rgba(124,58,237,0.2),rgba(79,70,229,0.2))":"none",border:"none",cursor:"pointer",borderRadius:12,transition:"all 0.15s"}}>
            <img src="https://ui-avatars.com/api/?name=Alan+Martinez&background=3B82F6&color=fff&size=36&bold=true" style={{width:36,height:36,borderRadius:"50%",border:"2px solid #3B82F6",flexShrink:0}} alt="perfil"/>
            <div style={{flex:1,textAlign:"left",minWidth:0}}>
              <div style={{fontSize:13,fontWeight:700,color:"#fff",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>Alan Martínez</div>
              <div style={{fontSize:11,color:"rgba(255,255,255,0.4)"}}>Administrador ∨</div>
            </div>
          </button>
        </div>
      </aside>
