...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .emisor-data{font-size:11px;opacity:.85;margin-top:10px;line-height:1.7}
  .emisor-data strong{opacity:1;font-size:12px}
  .tipo-doc{text-align:right}
  .tipo-doc .tipo{font-size:18px;font-weight:900;letter-spacing:.3px}
  .tipo-doc .serie{font-size:14px;font-family:monospace;margin-top:4px;opacity:.9}
  .tipo-doc .fecha{font-size:11px;opacity:.75;margin-top:6px}
  .body{padding:18px 26px}
  .section{margin-bottom:16px}
  .section-title{font-size:10px;font-weight:800;color:#374151;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:8px;padding-bottom:5px;border-bottom:2px solid #E5E7EB;display:flex;align-items:center;gap:6px}
  ...
  .tot-row .lbl{min-width:110px;text-align:right}
  ...
  .estado-badge{display:inline-block;padding:3px 10px;border-radius:5px;font-size:11px;font-weight:700;background:${factura.estado==="Cobrada"?"#DCFCE7":factura.estado==="Emitida"?"#DBEAFE":factura.estado==="Vencida"?"#FEE2E2":"#F3F4F6"};color:${factura.estado==="Cobrada"?"#15803D":factura.estado==="Emitida"?"#1D4ED8":factura.estado==="Vencida"?"#DC2626":"#374151"};-webkit-print-color-adjust:exact;print-color-adjust:exact}
</style>
</head>
<body>
<div class="doc">
  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="text-align:right;width:110px">V. Unit. S/ IGV</th>
            <th style="text-align:right;width:110px">Total S/ IGV</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>
              ...
              ${pan?`<br/><span style="font-size:11px;color:#6B7280">${pan.nombre}${pan.tipo?" · "+pan.tipo:""}${pan.ciudad?" · "+pan.ciudad:""}</span>`:""}
              ${pan?.direccion?`<br/><span style="font-size:10px;color:#9CA3AF">📍 ${pan.direccion}</span>`:""}
            </td>
      ...
      <div class="totales">
        <div class="tot-row"><span class="lbl">Valor Venta (sin IGV)</span><span class="val">S/ ${subtotal.toLocaleString("es-PE",{minimumFractionDigits:2})}</span></div>
    ...
    ${factura.notas?`<div class="section"><div class="section-title">📝 Observaciones</div><p style="font-size:12px;color:#6B7280;line-height:1.6;margin-top:2px">${factura.notas}</p></div>`:""}
  </div>
          ...
          <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px 16px"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              {[
                ...
                {l:"Valor s/IGV",  v:`S/ ${subtotal.toLocaleString("es-PE",{minimumFractionDigits:2})}`, c:C.text},
                {l:"IGV 18%",      v:`S/ ${igv.toLocaleString("es-PE",{minimumFractionDigits:2})}`,      c:C.text},
            ...
            <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
              ...
              <div>
                ...
                <div style={{display:"flex",gap:8,marginTop:10,flexWrap:"wrap"}}>
                  {["RUC 20615629431","IGV 18% incluido","Formato A4 imprimible"].map(t=>(
