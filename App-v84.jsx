...
export default function App(){
  ...
  return(<>
    ...
    <style>{`*{box-sizing:border-box;-webkit-tap-highlight-color:transparent}html{margin:0;padding:0;background:#020510;overflow:hidden;height:-webkit-fill-available;}body{margin:0;padding:0;background:#020510;overflow:hidden;height:100vh;min-height:-webkit-fill-available;}#root{height:100%;overflow:hidden;}::-webkit-scrollbar{display:none}@keyframes spin{to{transform:rotate(360deg)}}@keyframes pulse{from{opacity:.2}to{opacity:.6}}@keyframes starTwinkle{0%,100%{opacity:0.5;transform:scale(1)}50%{opacity:1;transform:scale(1.3)}}@keyframes dishPulse{0%,100%{opacity:0.35}50%{opacity:0.55}}`}</style>

    {splash&&<Splash done={()=>setSplash(false)}/>}
    {showConfig&&<ModalConfig onClose={()=>setShowConfig(false)}/>}

    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",height:"100dvh",width:"100%",color:C.text,overflow:"hidden",position:"relative"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100%",paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"8px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
      ...
      <div style={{
        ...
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"20px 20px 20px",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
