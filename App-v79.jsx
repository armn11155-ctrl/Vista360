...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#020510",height:"100dvh",width:"100%",color:C.text,overflow:"hidden",position:"relative"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100%",paddingTop:"max(10px, calc(env(safe-area-inset-top) + 6px))",paddingBottom:0,paddingLeft:"10px",paddingRight:"10px",gap:"10px",position:"relative",zIndex:1,boxSizing:"border-box"}}>
