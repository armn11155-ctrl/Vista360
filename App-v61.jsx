...
export default function App(){
  ...
  return(<>
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.bg,height:"100dvh",color:C.text,display:"flex",overflow:"hidden",alignItems:"stretch",position:"relative"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",paddingTop:"env(safe-area-inset-top)"}}>
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px 16px",paddingTop:16,paddingBottom:"env(safe-area-inset-bottom)",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
