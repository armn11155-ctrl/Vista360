...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  body{font-family:'Times New Roman',Times,serif;background:#fff;color:#1a1a1a;font-size:12.5px;line-height:1.55}
  ...
  .logo-sub{font-family:'Times New Roman',Times,serif;font-size:10.5px;opacity:.78;letter-spacing:1.5px;text-transform:uppercase;margin-top:2px}
  ...
  .tipo-doc .tipo{font-size:17px;font-weight:900;letter-spacing:.8px;font-family:'Times New Roman',Times,serif;text-transform:uppercase}
  ...
  .estado-badge{
    ...
    margin-top:8px;font-family:'Times New Roman',Times,serif;letter-spacing:.5px;text-transform:uppercase;
  ...
  .section-title{
    ...
    border-bottom:2px solid ${ACCENT_BLUE};font-family:'Times New Roman',Times,serif
  }
  .grid2{display:grid;grid-template-columns:1fr 1fr;gap:10px}
  .field{padding:6px 8px;background:${LIGHT_BLUE};border-radius:3px;border-left:3px solid ${ACCENT_BLUE}}
  .field label{font-size:8.5px;font-weight:700;color:${ACCENT_BLUE};text-transform:uppercase;letter-spacing:.8px;display:block;margin-bottom:2px;font-family:'Times New Roman',Times,serif}
  .field .value{font-size:12px;font-weight:600;color:#0f172a;font-family:'Times New Roman',Times,serif}
  ...
  thead th{
    ...
    font-family:'Times New Roman',Times,serif;letter-spacing:.6px;
    -webkit-print-color-adjust:exact;print-color-adjust:exact
  }
  tbody tr:nth-child(even){background:#F8FAFC}
  tbody td{padding:10px 11px;font-size:12px;color:#1e293b;border-bottom:1px solid #E2E8F0;font-family:'Times New Roman',Times,serif}
  ...
  .total-final .lbl{font-size:13px;font-weight:700;flex:1;letter-spacing:.5px;font-family:'Times New Roman',Times,serif;text-transform:uppercase}
  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <div class="totales">
        ...
        ${exonerado ? `<div class="tot-row" style="font-size:9.5px;color:#059669;margin-top:2px"><span class="lbl" style="color:#059669;font-style:italic">Base legal</span><span style="font-size:10px;color:#059669;min-width:220px;text-align:right;font-family:'Times New Roman',Times,serif">Art. 13° Ley N° 27037 — Zona Amazónica Huánuco</span></div>` : ""}
