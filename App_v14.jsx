  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "22px 22px 22px", maxWidth: "78%" }}>
        {/* 1. Resumen de hoy */}
        <div style={{ fontSize: 11, fontWeight: 700, color: "#5B9BFF", letterSpacing: 2.2, textTransform: "uppercase", marginBottom: 10 }}>
          Resumen de hoy
        </div>
        {/* 2. Saludo + nombre */}
        ...
        {/* 3. Fecha */}
        <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 30, padding: "4px 11px", marginBottom: 16 }}>
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>{fechaCap}</span>
        </div>
        {/* 4. Todo bajo control */}
        <div style={{ fontSize: 34, fontWeight: 800, color: "#FFFFFF", lineHeight: 1.02, letterSpacing: "-0.035em", marginBottom: 14 }}>
