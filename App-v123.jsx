...
const Card   = ({children,style={}})=><div style={{background:"{}",border:`1px solid rgba(79,124,255,0.13)`,borderRadius:16,padding:22,...style}}>{children}</div>;
...
function CRM({clientes,setClientes,contratos,loading}){
  ...
  const AvatarEmpresa=({name,size=34})=>{
    ...
    return(
      <div style={{
        ...
        fontSize:size*0.42,fontWeight:800,color:"#fff",textShadow:"0 1px 3px rgba(0,0,0,0.4)"}}>
        <div style={{position:"absolute",inset:0,borderRadius:10,background:"{}",pointerEvents:"none"}}/>
        {initial}
      </div>
    );
  };
  ...
  const AvatarContacto=({name,size=30})=>{
    ...
    return(
      <div style={{
        ...
        background:C.card,
        display:"flex",alignItems:"center",justifyContent:"center",
        fontSize:size*0.36,fontWeight:800,color:"#fff",textShadow:"0 1px 3px rgba(0,0,0,0.4)"}}>
        <div style={{position:"absolute",inset:0,borderRadius:"50%",background:"{}",pointerEvents:"none"}}/>
        {initials}
      </div>
    );
  };
  ...
  return(<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginBottom:20}}>
      <div style={{background:"{}",border:"1px solid rgba(16,185,129,0.25)",borderRadius:16,padding:"20px 20px 16px",position:"relative",overflow:"hidden",animationDelay:"0.05s"}}>
      ...
      <div style={{background:"{}",border:"1px solid rgba(124,58,237,0.28)",borderRadius:16,padding:"20px 20px 16px",position:"relative",overflow:"hidden",animationDelay:"0.1s"}}>
      ...
      <div style={{background:"{}",border:"1px solid rgba(245,158,11,0.25)",borderRadius:16,padding:"20px 20px 16px",position:"relative",overflow:"hidden",animationDelay:"0.15s"}}>
            ...
            return(
              <button key={i} onClick={()=>typeof n==="number"&&setPage(n)}
                style={{width:28,height:28,borderRadius:8,border:"none",cursor:"pointer",
                  background:page===n?"{}":"rgba(255,255,255,0.05)",
        ...
        :<div>
          <div style={{marginBottom:16}}>
            ...
            <div style={{background:C.border,borderRadius:8,height:10,overflow:"hidden"}}>
              <div style={{height:"100%",width:`${dbPct}%`,background:dbPct>80?"{}":dbPct>50?"{}":"{}",borderRadius:8,minWidth:dbPct>0?"6px":"0"}}/>
            </div>
      ...
      {storageStats.loading
        ...
        :<div>
          <div style={{marginBottom:16}}>
            ...
            <div style={{background:C.border,borderRadius:8,height:10,overflow:"hidden"}}>
              <div style={{height:"100%",width:`${Math.max(storagePct,storageStats.bytes>0?0.3:0)}%`,background:"{}",borderRadius:8}}/>
            </div>
      ...
      {notifPerm==="granted"
        ...
        :<div>
          <button onClick={activarNotif}
            style={{width:"100%",padding:"14px",background:"{}",border:"none",borderRadius:12,color:"#fff",fontWeight:700,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
...
function Gastos({gastos,setGastos}){
  ...
  const abrirEditar=(g)=>{
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
      ...
      <button onClick={abrirNuevo} style={{background:"{}",border:"none",borderRadius:12,padding:"10px 20px",color:"#fff",fontWeight:700,fontSize:13,cursor:"pointer"}}>+ Nuevo</button>
    </div>

    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",background:"{}",border:"1px solid #1E3050",borderRadius:16,padding:"14px 18px",marginBottom:18}}>
    ...
    {delMes.length===0
      ?<div style={{textAlign:"center",padding:"54px 20px",background:"{}",border:"1px solid #1E3050",borderRadius:20}}>
        ...
        <button onClick={abrirNuevo} style={{background:"{}",border:"none",borderRadius:12,padding:"11px 28px",color:"#fff",fontWeight:700,fontSize:14,cursor:"pointer"}}>+ Agregar gasto</button>
      </div>
      :<div style={{display:"flex",flexDirection:"column",gap:10}}>
        {delMes.map(g=>(
          <div key={g.id}
            onClick={()=>setVistaDetalle(g)}
            style={{background:"{}",border:"1px solid #1E3050",borderRadius:16,overflow:"hidden",cursor:"pointer"}}>
              ...
              {ocr.loading&&(
                <div style={{width:"100%",background:"#F0F9FF",border:"1px solid #BAE6FD",borderRadius:10,padding:"10px 12px"}}>
                  ...
                  <div style={{height:4,background:"#BAE6FD",borderRadius:2,overflow:"hidden"}}>
                    <div style={{height:"100%",width:`${ocr.progress}%`,background:"{}",borderRadius:2}}/>
                  </div>
                </div>
              )}
            </div>
        ...
        <div style={{background:"#0B1324",border:"1px solid #1E3050",borderRadius:"22px 22px 0 0",width:"100%",maxWidth:540,maxHeight:"93vh",overflowY:"auto",paddingBottom:36}}>
          ...
          <div style={{padding:"0 22px"}}>
            ...
            <div style={{display:"flex",gap:10}}>
              ...
              <button onClick={guardar} disabled={saving} style={{flex:1,padding:"13px",background:saving?"#1E3050":"{}",border:"none",borderRadius:12,color:"#fff",fontWeight:700,fontSize:14,cursor:saving?"not-allowed":"pointer",boxShadow:saving?"none":"0 4px 14px rgba(37,99,235,0.4)"}}>
      ...
      {[
        ...
        <button key={f.id} onClick={()=>setFiltro(f.id)}
          style={{padding:"8px 14px",borderRadius:9,border:"none",
            background:filtro===f.id?"{}":"transparent",
      ...
      <div style={{position:"fixed",inset:0,background:"#000000BB",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:20,padding:26,width:"100%",maxWidth:460}}>
          ...
          <div style={{display:"flex",gap:10}}>
            ...
            <button onClick={enviarEmail} disabled={enviandoEmail} style={{flex:2,padding:12,background:C.card,border:"none",borderRadius:10,color:C.white,fontWeight:700,fontSize:14,cursor:enviandoEmail?"wait":"pointer",opacity:enviandoEmail?0.7:1}}>
      ...
      <div style={{position:"fixed",inset:0,background:"#000000BB",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:20,padding:26,width:"100%",maxWidth:460}}>
          ...
          <div style={{display:"flex",gap:10}}>
            ...
            <button onClick={confirmarCobro} disabled={guardandoPago} style={{flex:2,padding:12,background:C.card,border:"none",borderRadius:10,color:"#000",fontWeight:800,fontSize:14,cursor:guardandoPago?"wait":"pointer",opacity:guardandoPago?0.7:1}}>
  ...
  return (
    <div style={{ paddingBottom: 32 }}>
      ...
      {contratosSinFactura.length > 0 && (
        <div style={{ background: "{}", border: `1px solid ${C.amber}44`, borderRadius: 16, padding: "14px 18px", marginBottom: 18 }}>
      ...
      {[
        ...
        <button key={v.id} onClick={()=>setVista(v.id)}
          style={{padding:"8px 18px",borderRadius:9,border:"none",
            background:vista===v.id?"{}":"transparent",
...
function Reportes({ contratos, paneles, clientes, gastos }) {
  ...
  return (
    <div>
      ...
      <div style={{display:"flex",gap:6,marginBottom:22,background:C.surface,
        ...
        {secciones.map(s=>(
          <button key={s.id} onClick={()=>setSeccion(s.id)} style={{
            ...
            background:seccion===s.id?"{}":"transparent",
      ...
      {seccion==="prefactura" && (
        <div>
          <Card style={{marginBottom:16,background:"{}"}}>
    ...
    <div style={{width:"100%",height:"100dvh",backgroundColor:C.bg,display:"flex",flexDirection:"column",margin:0,padding:0,fontFamily:"'DM Sans',sans-serif",color:C.text,overflow:"hidden",position:"relative"}}>
            ...
            {tabs.filter(t=>t.id!=="perfil").map(t=>{
              ...
              return(
                <button key={t.id} onClick={()=>handleTabClick(t.id)} style={{
                  ...
                  {active&&<div style={{position:"absolute",bottom:0,left:"25%",right:"25%",height:"2px",background:"{}",borderRadius:2,pointerEvents:"none"}}/>}
      ...
      <div style={{
        ...
        <main style={{height:"100%",overflowY:"auto",overflowX:"hidden",padding:"20px",paddingBottom:"calc(env(safe-area-inset-bottom) + 6px)",backgroundColor:C.bg}}>
          ...
          {showProfile&&(
            <div>
              <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:24,padding:"20px",background:"{}",borderRadius:20,border:"1px solid rgba(59,110,248,0.2)"}}>
