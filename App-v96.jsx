...
export default function App(){
  ...
  return(<>
    ...
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,width:"100vw",height:"100dvh",backgroundColor:C.bg,display:"flex",flexDirection:"row",margin:0,padding:0,overflow:"hidden",fontFamily:"'DM Sans',sans-serif",color:C.text}}>
      ...
      <div style={{
        ...
        <main style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"20px 20px",paddingBottom:"20px",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
